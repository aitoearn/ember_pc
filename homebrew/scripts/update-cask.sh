...
echo "🔄 更新 Ember Cask 到版本 $VERSION"

# 下载 DMG 并计算 sha256
ARM64_URL="https://github.com/$REPO/releases/download/v$VERSION/Ember_${VERSION}_aarch64.dmg"
X64_URL="https://github.com/$REPO/releases/download/v$VERSION/Ember_${VERSION}_x64.dmg"
...
echo ""
echo "下一步："
echo "  1. git add Casks/ember.rb"
echo "  2. git commit -m 'chore: bump ember to $VERSION'"
echo "  3. git push"
