...
const ASK_USER_QUESTIONS_SCHEMA_KEY: &str = "x-ember-ask-user-questions";
...
fn dynamic_filtering_enabled() -> bool {
    ember_core::tool_calling::tool_calling_dynamic_filtering_enabled()
}
...
fn convert_turn_status(
    status: TurnStatus,
) -> ember_core::database::dao::agent_timeline::AgentThreadTurnStatus {
    match status {
        TurnStatus::Queued | TurnStatus::Running => {
            ember_core::database::dao::agent_timeline::AgentThreadTurnStatus::Running
        }
        TurnStatus::Completed => {
            ember_core::database::dao::agent_timeline::AgentThreadTurnStatus::Completed
        }
        TurnStatus::Failed => {
            ember_core::database::dao::agent_timeline::AgentThreadTurnStatus::Failed
        }
        TurnStatus::Aborted => {
            ember_core::database::dao::agent_timeline::AgentThreadTurnStatus::Aborted
        }
    }
}
...
fn convert_item_status(
    status: ItemStatus,
) -> ember_core::database::dao::agent_timeline::AgentThreadItemStatus {
    match status {
        ItemStatus::InProgress => {
            ember_core::database::dao::agent_timeline::AgentThreadItemStatus::InProgress
        }
        ItemStatus::Completed => {
            ember_core::database::dao::agent_timeline::AgentThreadItemStatus::Completed
        }
        ItemStatus::Failed => {
            ember_core::database::dao::agent_timeline::AgentThreadItemStatus::Failed
        }
    }
}
