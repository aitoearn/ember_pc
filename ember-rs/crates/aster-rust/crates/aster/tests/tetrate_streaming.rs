...
mod tetrate_streaming_tests {
    ...
    fn skip_real_api_test(test_name: &str) -> bool {
        ...
        println!("Skipping {test_name} - set EMBER_REAL_API_TEST=1 to run real Tetrate smoke");
        true
    }
    ...
    #[tokio::test]
    #[serial]
    #[ignore = "requires EMBER_REAL_API_TEST=1; sends a request to the Tetrate service"]
