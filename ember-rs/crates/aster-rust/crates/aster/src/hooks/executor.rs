...
const PROMPT_HOOK_SYSTEM_PROMPT: &str = r#"You are evaluating an Aster/Ember prompt hook.
...
const AGENT_HOOK_SYSTEM_PROMPT: &str = r#"You are evaluating an Aster/Ember agent hook.
