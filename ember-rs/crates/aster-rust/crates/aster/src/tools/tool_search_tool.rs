...
mod tests {
    ...
    fn test_resolve_selected_tools_matches_inner_prefixed_tool_name() {
        let deferred = vec![searchable(
            "mcp__ember-browser__browser_file_upload",
        ...
        assert_eq!(
            matches,
            vec!["mcp__ember-browser__browser_file_upload".to_string()]
        );
    }
    ...
    fn test_resolve_selected_tools_normalizes_server_prefix_variants() {
        ...
        let matches = resolve_selected_tools(
            &["mcp__ember_browser__browser_file_upload".to_string()],
            &deferred,
            &all,
        );
    ...
    fn test_score_query_match_splits_identifier_queries() {
        let deferred = vec![searchable(
            "mcp__ember-browser__workspace_read_file",
        ...
        assert_eq!(
            matches,
            vec!["mcp__ember-browser__workspace_read_file".to_string()]
        );
    }
