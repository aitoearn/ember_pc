...
const EMBER_RUNTIME_AUTO_COMPACT_KEY: &str = "auto_compact";
    ...
    crate::session_context::current_turn_context()
        .and_then(|turn_context| {
            turn_context
                ...
                .and_then(|metadata| metadata.get(EMBER_RUNTIME_AUTO_COMPACT_KEY))
...
mod tests {
    ...
    fn build_auto_compaction_turn_context(enabled: bool) -> TurnContextOverride {
        ...
        metadata.insert(
            ...
            serde_json::json!({
                EMBER_RUNTIME_AUTO_COMPACT_KEY: enabled,
            }),
        );
        TurnContextOverride {
            metadata,
