...
pub(crate) async fn wait_wechat_channel_login(
    ...
    if result.connected {
        ...
        let account = accounts
            ...
            .or_insert_with(ember_core::config::WechatAccountConfig::default);
