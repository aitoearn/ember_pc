...
use ember_core::config::AsrCredentialEntry as CoreAsrCredentialEntry;
use ember_core::config::AsrProviderType as CoreAsrProviderType;
use ember_core::config::BaiduConfig as CoreBaiduConfig;
use ember_core::config::OpenAIAsrConfig as CoreOpenAIAsrConfig;
use ember_core::config::SenseVoiceLocalConfig as CoreSenseVoiceLocalConfig;
use ember_core::config::WhisperLocalConfig as CoreWhisperLocalConfig;
use ember_core::config::WhisperModelSize as CoreWhisperModelSize;
use ember_core::config::XunfeiConfig as CoreXunfeiConfig;
use ember_services::voice_asr_service::AsrService;
...
fn default_voice_model_install_dir(model_id: &str) -> String {
    ember_core::app_paths::best_effort_data_dir()
        .join("models")
        .join("voice")
        .join(model_id)
        .to_string_lossy()
