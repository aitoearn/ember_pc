...
use ember_agent::initialize_aster_runtime;
...
use ember_core::logger;
use ember_gateway::discord::DiscordGatewayState;
use ember_gateway::feishu::FeishuGatewayState;
use ember_gateway::telegram::TelegramGatewayState;
use ember_gateway::tunnel::GatewayTunnelState;
use ember_gateway::wechat::WechatGatewayState;
use ember_gateway::wechat::WechatLoginState;
use ember_mcp::McpClientManager;
...
pub struct LocalAppDataSource {
    db: DbConnection,
    logs: std::sync::Arc<tokio::sync::RwLock<ember_core::logger::LogStore>>,
...
impl AppDataSource for LocalAppDataSource {
    ...
    async fn list_test_cases(
        ...
        test_cases::list_test_cases(&self.db, params)
    }
    ...
    async fn read_test_case(
        ...
        test_cases::read_test_case(&self.db, params)
    }
    ...
    async fn save_test_case(
        ...
        test_cases::save_test_case(&self.db, params)
    }
    ...
    async fn delete_test_cases(
        ...
        test_cases::delete_test_cases(&self.db, params)
    }
    ...
    async fn list_test_case_modules(
        ...
        test_cases::list_test_case_modules(&self.db, params)
    }
    ...
    async fn save_test_case_module(
        ...
        test_cases::save_test_case_module(&self.db, params)
    }
    ...
    async fn delete_test_case_module(
        ...
        test_cases::delete_test_case_module(&self.db, params)
    }
    ...
    async fn save_test_case_run(
        ...
        test_cases::save_test_case_run(&self.db, params)
    }
    ...
    async fn list_test_case_runs(
        ...
        test_cases::list_test_case_runs(&self.db, params)
    }
    ...
    async fn save_perf_monitor_session(
        ...
        perf_monitor::save_perf_monitor_session(&self.db, params)
    }
    ...
    async fn list_perf_monitor_sessions(
        ...
        perf_monitor::list_perf_monitor_sessions(&self.db, params)
    }
    ...
    async fn read_perf_monitor_session(
        ...
        perf_monitor::read_perf_monitor_session(&self.db, params)
    }
    ...
    async fn list_device_flows(
        ...
        device_flow::list_device_flows(&self.db, params)
    }
    ...
    async fn read_device_flow(
        ...
        device_flow::read_device_flow(&self.db, params)
    }
    ...
    async fn save_device_flow(
        ...
        device_flow::save_device_flow(&self.db, params)
    }
    ...
    async fn delete_device_flows(
        ...
        device_flow::delete_device_flows(&self.db, params)
    }
    ...
    async fn save_device_flow_run(
        ...
        device_flow::save_device_flow_run(&self.db, params)
    }
    ...
    async fn list_device_flow_runs(
        ...
        device_flow::list_device_flow_runs(&self.db, params)
    }
    ...
    async fn read_device_flow_run(
        ...
        device_flow::read_device_flow_run(&self.db, params)
    }
    ...
    async fn list_device_flow_healing(
        ...
        device_flow::list_device_flow_healing(&self.db, params)
    }
    ...
    async fn save_device_flow_healing(
        ...
        device_flow::save_device_flow_healing(&self.db, params)
    }
    ...
    async fn resolve_device_flow_healing(
        ...
        device_flow::resolve_device_flow_healing(&self.db, params)
    }
    ...
    async fn read_device_explore_profile(
        ...
        device_explore::read_device_explore_profile(&self.db, params)
    }
    ...
    async fn save_device_explore_profile(
        ...
        device_explore::save_device_explore_profile(&self.db, params)
    }
    ...
    async fn save_device_explore_run(
        ...
        device_explore::save_device_explore_run(&self.db, params)
    }
    ...
    async fn list_device_explore_runs(
        ...
        device_explore::list_device_explore_runs(&self.db, params)
    }
    ...
    async fn read_device_explore_run(
        ...
        device_explore::read_device_explore_run(&self.db, params)
    }
    ...
    async fn save_perf_monitor_trace(
        ...
        perf_trace::save_perf_monitor_trace(&self.db, params)
    }
    ...
    async fn list_perf_monitor_traces(
        ...
        perf_trace::list_perf_monitor_traces(&self.db, params)
    }
    ...
    async fn read_perf_monitor_trace(
        ...
        perf_trace::read_perf_monitor_trace(&self.db, params)
    }
    ...
    async fn delete_perf_monitor_trace(
        ...
        perf_trace::delete_perf_monitor_trace(&self.db, params)
    }
    ...
    async fn save_perf_monitor_trace_analysis(
        ...
        perf_trace::save_perf_monitor_trace_analysis(&self.db, params)
    }
    ...
    async fn list_perf_monitor_trace_analyses(
        ...
        perf_trace::list_perf_monitor_trace_analyses(&self.db, params)
    }
    ...
    async fn read_project_memory(
        ...
        let memory = ember_core::memory::read_project_memory(self.db.clone(), &params.project_id)
            .map_err(data_error)?;
