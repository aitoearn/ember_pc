...
struct TestCurrentTimelineDataSource {
    ...
    knowledge_compile_requests: Mutex<Vec<ember_knowledge::KnowledgeCompilePackRequest>>,
}
...
impl TestCurrentTimelineDataSource {
    ...
    fn knowledge_compile_requests(&self) -> Vec<ember_knowledge::KnowledgeCompilePackRequest> {
...
struct TestKnowledgeBuilderRuntimeExecutor {
    calls: Mutex<Vec<ember_knowledge::KnowledgeBuilderRuntimePlan>>,
}
...
impl TestKnowledgeBuilderRuntimeExecutor {
    ...
    fn calls(&self) -> Vec<ember_knowledge::KnowledgeBuilderRuntimePlan> {
        self.calls
            .lock()
...
impl KnowledgeBuilderRuntimeExecutor for TestKnowledgeBuilderRuntimeExecutor {
    async fn execute(
        &self,
        plan: ember_knowledge::KnowledgeBuilderRuntimePlan,
    ) -> Result<ember_knowledge::KnowledgeBuilderRuntimeExecution, RuntimeCoreError> {
        self.calls
            .lock()
            .expect("test knowledge builder calls mutex poisoned")
            .push(plan.clone());
        Ok(ember_knowledge::KnowledgeBuilderRuntimeExecution {
...
impl AppDataSource for TestCurrentTimelineDataSource {
    ...
    async fn list_device_flows(
        &self,
        params: app_server_protocol::DeviceFlowListParams,
    ) -> Result<app_server_protocol::DeviceFlowListResponse, RuntimeCoreError> {
        NoopAppDataSource.list_device_flows(params).await
    }

    async fn read_device_flow(
        &self,
        params: app_server_protocol::DeviceFlowReadParams,
    ) -> Result<app_server_protocol::DeviceFlowReadResponse, RuntimeCoreError> {
        NoopAppDataSource.read_device_flow(params).await
    }

    async fn save_device_flow(
        &self,
        params: app_server_protocol::DeviceFlowSaveParams,
    ) -> Result<app_server_protocol::DeviceFlowSaveResponse, RuntimeCoreError> {
        NoopAppDataSource.save_device_flow(params).await
    }

    async fn delete_device_flows(
        &self,
        params: app_server_protocol::DeviceFlowDeleteParams,
    ) -> Result<app_server_protocol::DeviceFlowDeleteResponse, RuntimeCoreError> {
        NoopAppDataSource.delete_device_flows(params).await
    }

    async fn save_device_flow_run(
        &self,
        params: app_server_protocol::DeviceFlowRunSaveParams,
    ) -> Result<app_server_protocol::DeviceFlowRunSaveResponse, RuntimeCoreError> {
        NoopAppDataSource.save_device_flow_run(params).await
    }

    async fn list_device_flow_runs(
        &self,
        params: app_server_protocol::DeviceFlowRunListParams,
    ) -> Result<app_server_protocol::DeviceFlowRunListResponse, RuntimeCoreError> {
        NoopAppDataSource.list_device_flow_runs(params).await
    }

    async fn read_device_flow_run(
        &self,
        params: app_server_protocol::DeviceFlowRunReadParams,
    ) -> Result<app_server_protocol::DeviceFlowRunReadResponse, RuntimeCoreError> {
        NoopAppDataSource.read_device_flow_run(params).await
    }

    async fn list_device_flow_healing(
        &self,
        params: app_server_protocol::DeviceFlowHealingListParams,
    ) -> Result<app_server_protocol::DeviceFlowHealingListResponse, RuntimeCoreError> {
        NoopAppDataSource.list_device_flow_healing(params).await
    }

    async fn save_device_flow_healing(
        &self,
        params: app_server_protocol::DeviceFlowHealingSaveParams,
    ) -> Result<app_server_protocol::DeviceFlowHealingSaveResponse, RuntimeCoreError> {
        NoopAppDataSource.save_device_flow_healing(params).await
    }

    async fn resolve_device_flow_healing(
        &self,
        params: app_server_protocol::DeviceFlowHealingResolveParams,
    ) -> Result<app_server_protocol::DeviceFlowHealingResolveResponse, RuntimeCoreError> {
        NoopAppDataSource.resolve_device_flow_healing(params).await
    }

    async fn read_device_explore_profile(
        &self,
        params: app_server_protocol::DeviceExploreReadParams,
    ) -> Result<app_server_protocol::DeviceExploreReadResponse, RuntimeCoreError> {
        NoopAppDataSource.read_device_explore_profile(params).await
    }

    async fn save_device_explore_profile(
        &self,
        params: app_server_protocol::DeviceExploreSaveParams,
    ) -> Result<app_server_protocol::DeviceExploreSaveResponse, RuntimeCoreError> {
        NoopAppDataSource.save_device_explore_profile(params).await
    }

    async fn save_device_explore_run(
        &self,
        params: app_server_protocol::DeviceExploreRunSaveParams,
    ) -> Result<app_server_protocol::DeviceExploreRunSaveResponse, RuntimeCoreError> {
        NoopAppDataSource.save_device_explore_run(params).await
    }

    async fn list_device_explore_runs(
        &self,
        params: app_server_protocol::DeviceExploreRunListParams,
    ) -> Result<app_server_protocol::DeviceExploreRunListResponse, RuntimeCoreError> {
        NoopAppDataSource.list_device_explore_runs(params).await
    }

    async fn read_device_explore_run(
        &self,
        params: app_server_protocol::DeviceExploreRunReadParams,
    ) -> Result<app_server_protocol::DeviceExploreRunReadResponse, RuntimeCoreError> {
        NoopAppDataSource.read_device_explore_run(params).await
    }

    async fn list_test_cases(
        &self,
        params: app_server_protocol::TestCaseListParams,
    ) -> Result<app_server_protocol::TestCaseListResponse, RuntimeCoreError> {
        NoopAppDataSource.list_test_cases(params).await
    }

    async fn read_test_case(
        &self,
        params: app_server_protocol::TestCaseReadParams,
    ) -> Result<app_server_protocol::TestCaseReadResponse, RuntimeCoreError> {
        NoopAppDataSource.read_test_case(params).await
    }

    async fn save_test_case(
        &self,
        params: app_server_protocol::TestCaseSaveParams,
    ) -> Result<app_server_protocol::TestCaseSaveResponse, RuntimeCoreError> {
        NoopAppDataSource.save_test_case(params).await
    }

    async fn delete_test_cases(
        &self,
        params: app_server_protocol::TestCaseDeleteParams,
    ) -> Result<app_server_protocol::TestCaseDeleteResponse, RuntimeCoreError> {
        NoopAppDataSource.delete_test_cases(params).await
    }

    async fn list_test_case_modules(
        &self,
        params: app_server_protocol::TestCaseModuleListParams,
    ) -> Result<app_server_protocol::TestCaseModuleListResponse, RuntimeCoreError> {
        NoopAppDataSource.list_test_case_modules(params).await
    }

    async fn save_test_case_module(
        &self,
        params: app_server_protocol::TestCaseModuleSaveParams,
    ) -> Result<app_server_protocol::TestCaseModuleSaveResponse, RuntimeCoreError> {
        NoopAppDataSource.save_test_case_module(params).await
    }

    async fn delete_test_case_module(
        &self,
        params: app_server_protocol::TestCaseModuleDeleteParams,
    ) -> Result<app_server_protocol::TestCaseModuleDeleteResponse, RuntimeCoreError> {
        NoopAppDataSource.delete_test_case_module(params).await
    }

    async fn save_test_case_run(
        &self,
        params: app_server_protocol::TestCaseRunSaveParams,
    ) -> Result<app_server_protocol::TestCaseRunSaveResponse, RuntimeCoreError> {
        NoopAppDataSource.save_test_case_run(params).await
    }

    async fn list_test_case_runs(
        &self,
        params: app_server_protocol::TestCaseRunListParams,
    ) -> Result<app_server_protocol::TestCaseRunListResponse, RuntimeCoreError> {
        NoopAppDataSource.list_test_case_runs(params).await
    }

    async fn save_perf_monitor_session(
        &self,
        params: app_server_protocol::PerfMonitorSessionSaveParams,
    ) -> Result<app_server_protocol::PerfMonitorSessionSaveResponse, RuntimeCoreError> {
        NoopAppDataSource.save_perf_monitor_session(params).await
    }

    async fn list_perf_monitor_sessions(
        &self,
        params: app_server_protocol::PerfMonitorSessionListParams,
    ) -> Result<app_server_protocol::PerfMonitorSessionListResponse, RuntimeCoreError> {
        NoopAppDataSource.list_perf_monitor_sessions(params).await
    }

    async fn read_perf_monitor_session(
        &self,
        params: app_server_protocol::PerfMonitorSessionReadParams,
    ) -> Result<app_server_protocol::PerfMonitorSessionReadResponse, RuntimeCoreError> {
        NoopAppDataSource.read_perf_monitor_session(params).await
    }

    async fn save_perf_monitor_trace(
        &self,
        params: app_server_protocol::PerfMonitorTraceSaveParams,
    ) -> Result<app_server_protocol::PerfMonitorTraceSaveResponse, RuntimeCoreError> {
        NoopAppDataSource.save_perf_monitor_trace(params).await
    }

    async fn list_perf_monitor_traces(
        &self,
        params: app_server_protocol::PerfMonitorTraceListParams,
    ) -> Result<app_server_protocol::PerfMonitorTraceListResponse, RuntimeCoreError> {
        NoopAppDataSource.list_perf_monitor_traces(params).await
    }

    async fn read_perf_monitor_trace(
        &self,
        params: app_server_protocol::PerfMonitorTraceReadParams,
    ) -> Result<app_server_protocol::PerfMonitorTraceReadResponse, RuntimeCoreError> {
        NoopAppDataSource.read_perf_monitor_trace(params).await
    }

    async fn delete_perf_monitor_trace(
        &self,
        params: app_server_protocol::PerfMonitorTraceDeleteParams,
    ) -> Result<app_server_protocol::PerfMonitorTraceDeleteResponse, RuntimeCoreError> {
        NoopAppDataSource.delete_perf_monitor_trace(params).await
    }

    async fn save_perf_monitor_trace_analysis(
        &self,
        params: app_server_protocol::PerfMonitorTraceAnalysisSaveParams,
    ) -> Result<app_server_protocol::PerfMonitorTraceAnalysisSaveResponse, RuntimeCoreError> {
        NoopAppDataSource.save_perf_monitor_trace_analysis(params).await
    }

    async fn list_perf_monitor_trace_analyses(
        &self,
        params: app_server_protocol::PerfMonitorTraceAnalysisListParams,
    ) -> Result<app_server_protocol::PerfMonitorTraceAnalysisListResponse, RuntimeCoreError> {
        NoopAppDataSource.list_perf_monitor_trace_analyses(params).await
    }
    ...
    async fn compile_knowledge_pack(
        ...
        self.knowledge_compile_requests
            ...
            .push(request.clone());
        let response =
            ember_knowledge::compile_knowledge_pack(request).map_err(RuntimeCoreError::Backend)?;
...
impl EvidenceExportProvider for TestEvidenceExportProvider {
    async fn export_evidence_pack(
        ...
        Ok(Some(EvidencePackSummary {
            pack_relative_root: ".ember/harness/sessions/sess_evidence/evidence".to_string(),
            pack_absolute_root: Some(
                "/workspace/.ember/harness/sessions/sess_evidence/evidence".to_string(),
            ),
            ...
            artifacts: vec![EvidencePackArtifact {
                ...
                relative_path: ".ember/harness/sessions/sess_evidence/evidence/summary.md"
                    .to_string(),
                absolute_path: None,
                bytes: 128,
            }],
...
async fn objective_audit_writes_current_evidence_pack_decision() {
    ...
    assert_eq!(
        ...
        Some("/workspace/.ember/harness/sessions/sess_evidence/evidence")
    );
...
async fn read_session_projects_runtime_events_into_thread_read_artifacts() {
        ...
        vec![RuntimeEvent::new(
            ...
            json!({
                "artifact": {
                    ...
                    "path": ".ember/artifacts/content-batch.json",
                    "title": "Content Batch",
    ...
    assert_eq!(artifacts[0]["path"], ".ember/artifacts/content-batch.json");
...
async fn read_artifacts_indexes_latest_artifact_events_for_session() {
    ...
    core.append_external_runtime_events(
        ...
        vec![
            RuntimeEvent::new(
                ...
                json!({
                    "artifactId": "artifact-report",
                    "filePath": ".ember/artifacts/report-v1.md",
                    "title": "Report",
            ...
            RuntimeEvent::new(
                ...
                json!({
                    "artifactId": "artifact-report",
                    "filePath": ".ember/artifacts/report-v2.md",
                    "title": "Report",
                    "kind": "markdown_report",
                    "status": "ready",
                    "metadata": {
            ...
            RuntimeEvent::new(
                ...
                json!({
                    "artifact": {
                        "id": "artifact-outline",
                        "path": ".ember/artifacts/outline.md",
                        "content": "# Outline"
                    }
                }),
            ),
    ...
    assert_eq!(
        ...
        Some(".ember/artifacts/outline.md")
    );
    ...
    assert_eq!(
        ...
        Some(".ember/artifacts/report-v2.md")
    );
    assert_eq!(
...
async fn export_handoff_bundle_writes_current_session_bundle_to_workspace() {
    ...
    assert_eq!(
        ...
        ".ember/harness/sessions/sess_handoff"
    );
    ...
    for artifact in &response.artifacts {
        ...
        assert!(artifact
            .relative_path
            .starts_with(".ember/harness/sessions/sess_handoff/"));
...
async fn default_runtime_exports_basic_evidence_pack_without_desktop_provider() {
    ...
    assert_eq!(
        ...
        ".ember/harness/sessions/sess_basic_evidence/evidence"
    );
    assert_eq!(evidence_pack.thread_status, "running");
    assert_eq!(
        evidence_pack
