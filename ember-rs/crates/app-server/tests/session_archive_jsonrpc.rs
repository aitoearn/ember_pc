...
impl AppDataSource for PersistedSessionArchiveDataSource {
    async fn list_test_cases(
        &self,
        _params: app_server_protocol::TestCaseListParams,
    ...
    async fn read_test_case(
        &self,
        _params: app_server_protocol::TestCaseReadParams,
    ...
    async fn save_test_case(
        &self,
        _params: app_server_protocol::TestCaseSaveParams,
    ...
    async fn delete_test_cases(
        &self,
        _params: app_server_protocol::TestCaseDeleteParams,
    ...
    async fn list_test_case_modules(
        &self,
        _params: app_server_protocol::TestCaseModuleListParams,
    ...
    async fn save_test_case_module(
        &self,
        _params: app_server_protocol::TestCaseModuleSaveParams,
    ...
    async fn delete_test_case_module(
        &self,
        _params: app_server_protocol::TestCaseModuleDeleteParams,
    ...
    async fn save_test_case_run(
        &self,
        _params: app_server_protocol::TestCaseRunSaveParams,
    ...
    async fn list_test_case_runs(
        &self,
        _params: app_server_protocol::TestCaseRunListParams,
    ...
    async fn save_perf_monitor_session(
        &self,
        _params: app_server_protocol::PerfMonitorSessionSaveParams,
    ...
    async fn list_perf_monitor_sessions(
        &self,
        _params: app_server_protocol::PerfMonitorSessionListParams,
    ...
    async fn read_perf_monitor_session(
        &self,
        _params: app_server_protocol::PerfMonitorSessionReadParams,
    ...
    async fn save_perf_monitor_trace(
        &self,
        _params: app_server_protocol::PerfMonitorTraceSaveParams,
    ...
    async fn list_perf_monitor_traces(
        &self,
        _params: app_server_protocol::PerfMonitorTraceListParams,
    ...
    async fn read_perf_monitor_trace(
        &self,
        _params: app_server_protocol::PerfMonitorTraceReadParams,
    ...
    async fn delete_perf_monitor_trace(
        &self,
        _params: app_server_protocol::PerfMonitorTraceDeleteParams,
    ...
    async fn save_perf_monitor_trace_analysis(
        &self,
        _params: app_server_protocol::PerfMonitorTraceAnalysisSaveParams,
    ...
    async fn list_perf_monitor_trace_analyses(
        &self,
        _params: app_server_protocol::PerfMonitorTraceAnalysisListParams,
...
fn seed_sqlite_current_timeline_session(db_path: &Path, workspace_root: &Path) {
    ...
    ember_core::database::schema::create_tables(&conn).expect("create isolated app-server schema");
