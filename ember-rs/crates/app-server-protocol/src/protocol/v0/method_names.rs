...
pub const METHOD_UNIFIED_MEMORY_LIST: &str = "unifiedMemory/list";
pub const METHOD_UNIFIED_MEMORY_GET: &str = "unifiedMemory/get";
pub const METHOD_UNIFIED_MEMORY_CREATE: &str = "unifiedMemory/create";
pub const METHOD_UNIFIED_MEMORY_UPDATE: &str = "unifiedMemory/update";
pub const METHOD_UNIFIED_MEMORY_DELETE: &str = "unifiedMemory/delete";
pub const METHOD_UNIFIED_MEMORY_SEARCH: &str = "unifiedMemory/search";
pub const METHOD_UNIFIED_MEMORY_STATS: &str = "unifiedMemory/stats";
pub const METHOD_UNIFIED_MEMORY_ANALYZE: &str = "unifiedMemory/analyze";
pub const METHOD_UNIFIED_MEMORY_SEMANTIC_SEARCH: &str = "unifiedMemory/semanticSearch";
pub const METHOD_UNIFIED_MEMORY_HYBRID_SEARCH: &str = "unifiedMemory/hybridSearch";
...
// P2 · Perfetto trace artifact 与分析
...
// 确定性可复现测试流与自愈回放（deviceFlow / deviceFlowRun / deviceFlowHealing）
