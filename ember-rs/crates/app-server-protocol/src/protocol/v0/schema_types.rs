pub const V0_SCHEMA_TYPE_NAMES: &[&str] = &[
    ...
    "PluginInstalledSaveParams",
    "PluginInstalledDisabledSetParams",
    "PluginInstalledListResponse",
    "PluginUninstallRehearsalParams",
    "PluginUninstallRehearsalResponse",
    "PluginUninstallRehearsalTarget",
    "PluginUninstallParams",
    "PluginUninstallResponse",
    "PluginHostLifecycleListResponse",
    "PluginHostLifecycleSnapshot",
    "PluginHostFunctionState",
    "PluginRightSurfaceContract",
    "PluginArticleWorkspaceContract",
    "PluginArticleWorkspaceObject",
    ...
    "DeviceFlowReadResponse",
    "DeviceFlowSaveParams",
    "DeviceFlowSaveResponse",
