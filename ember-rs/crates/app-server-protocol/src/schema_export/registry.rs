...
pub(super) fn v0_schemas() -> Vec<GeneratedJsonSchema> {
    vec![
        ...
        typed_schema::<AppServerRequestAccess>("AppServerRequestAccess"),
        typed_schema::<AppServerRequestAccessSpec>("AppServerRequestAccessSpec"),
        ...
        typed_schema::<TextPosition>("TextPosition"),
        typed_schema::<TextRange>("TextRange"),
        typed_schema::<ConfigWarningNotification>("ConfigWarningNotification"),
        typed_schema::<ServerRequestResolvedNotification>("ServerRequestResolvedNotification"),
        ...
        typed_schema::<SkillScope>("SkillScope"),
        typed_schema::<SkillSource>("SkillSource"),
        typed_schema::<SkillAuthority>("SkillAuthority"),
        typed_schema::<SkillInterface>("SkillInterface"),
        typed_schema::<SkillToolDependency>("SkillToolDependency"),
        typed_schema::<SkillDependencies>("SkillDependencies"),
        typed_schema::<SkillPolicy>("SkillPolicy"),
        typed_schema::<SkillLocator>("SkillLocator"),
        typed_schema::<SkillSummary>("SkillSummary"),
        typed_schema::<SkillWorkflowStep>("SkillWorkflowStep"),
        typed_schema::<SkillDetail>("SkillDetail"),
        typed_schema::<SkillListResponse>("SkillListResponse"),
        typed_schema::<SkillReadResponse>("SkillReadResponse"),
        typed_schema::<SkillManagementListResponse>("SkillManagementListResponse"),
        ...
        typed_schema::<VoiceTranscriptionPolishTextParams>("VoiceTranscriptionPolishTextParams"),
        typed_schema::<VoiceTranscriptionPolishTextResponse>(
        ...
        typed_schema::<BrowserSessionTargetListParams>("BrowserSessionTargetListParams"),
        typed_schema::<BrowserSessionTargetInfo>("BrowserSessionTargetInfo"),
        typed_schema::<BrowserSessionTargetListResponse>("BrowserSessionTargetListResponse"),
        typed_schema::<BrowserSessionOpenParams>("BrowserSessionOpenParams"),
        typed_schema::<BrowserSessionIdParams>("BrowserSessionIdParams"),
        typed_schema::<BrowserSessionEventListParams>("BrowserSessionEventListParams"),
        typed_schema::<BrowserSessionActionExecuteParams>("BrowserSessionActionExecuteParams"),
        typed_schema::<BrowserSessionPageInfo>("BrowserSessionPageInfo"),
        typed_schema::<BrowserSessionState>("BrowserSessionState"),
        typed_schema::<BrowserSessionOpenResponse>("BrowserSessionOpenResponse"),
        typed_schema::<BrowserSessionReadResponse>("BrowserSessionReadResponse"),
        typed_schema::<BrowserSessionCloseResponse>("BrowserSessionCloseResponse"),
        typed_schema::<BrowserSessionEventItem>("BrowserSessionEventItem"),
        typed_schema::<BrowserSessionEventListResponse>("BrowserSessionEventListResponse"),
        ...
        typed_schema::<PluginPackageIdentity>("PluginPackageIdentity"),
        typed_schema::<PluginInstalledSaveParams>("PluginInstalledSaveParams"),
        typed_schema::<PluginInstalledDisabledSetParams>("PluginInstalledDisabledSetParams"),
        typed_schema::<PluginInstalledListResponse>("PluginInstalledListResponse"),
        typed_schema::<PluginUninstallRehearsalParams>("PluginUninstallRehearsalParams"),
        typed_schema::<PluginUninstallRehearsalResponse>("PluginUninstallRehearsalResponse"),
        typed_schema::<PluginUninstallRehearsalTarget>("PluginUninstallRehearsalTarget"),
        typed_schema::<PluginUninstallParams>("PluginUninstallParams"),
        typed_schema::<PluginUninstallResponse>("PluginUninstallResponse"),
        typed_schema::<PluginHostLifecycleListResponse>("PluginHostLifecycleListResponse"),
        typed_schema::<PluginHostLifecycleSnapshot>("PluginHostLifecycleSnapshot"),
        typed_schema::<PluginHostFunctionState>("PluginHostFunctionState"),
        typed_schema::<PluginRightSurfaceContract>("PluginRightSurfaceContract"),
        typed_schema::<PluginArticleWorkspaceContract>("PluginArticleWorkspaceContract"),
        typed_schema::<PluginArticleWorkspaceObject>("PluginArticleWorkspaceObject"),
        typed_schema::<PluginHistoryRestoreContract>("PluginHistoryRestoreContract"),
        typed_schema::<PluginTaskRuntimeContract>("PluginTaskRuntimeContract"),
        typed_schema::<PluginDeleteDataExecutionEvidence>("PluginDeleteDataExecutionEvidence"),
        typed_schema::<PluginDeleteDataTargetEvidence>("PluginDeleteDataTargetEvidence"),
        typed_schema::<PluginDeleteDataPostDeleteResidualAudit>(
            "PluginDeleteDataPostDeleteResidualAudit",
        ),
        typed_schema::<PluginShellPrepareParams>("PluginShellPrepareParams"),
        typed_schema::<PluginShellPrepareResponse>("PluginShellPrepareResponse"),
        typed_schema::<PluginShellPackageMount>("PluginShellPackageMount"),
        typed_schema::<PluginUiRuntimeStartParams>("PluginUiRuntimeStartParams"),
        typed_schema::<PluginUiRuntimeStatusParams>("PluginUiRuntimeStatusParams"),
        typed_schema::<PluginUiRuntimeStopParams>("PluginUiRuntimeStopParams"),
        typed_schema::<PluginUiRuntimeStatusResponse>("PluginUiRuntimeStatusResponse"),
        typed_schema::<SoulStylePackInstallStatus>("SoulStylePackInstallStatus"),
        typed_schema::<SoulStylePackMutableStatus>("SoulStylePackMutableStatus"),
        typed_schema::<SoulStylePackInstallParams>("SoulStylePackInstallParams"),
        typed_schema::<SoulStylePackListParams>("SoulStylePackListParams"),
        typed_schema::<SoulStylePackListEntry>("SoulStylePackListEntry"),
        typed_schema::<SoulStylePackListResponse>("SoulStylePackListResponse"),
        typed_schema::<SoulStylePackInstallResponse>("SoulStylePackInstallResponse"),
        typed_schema::<SoulStylePackStatusSetParams>("SoulStylePackStatusSetParams"),
        typed_schema::<SoulStylePackStatusSetResponse>("SoulStylePackStatusSetResponse"),
        typed_schema::<SoulStylePackUninstallParams>("SoulStylePackUninstallParams"),
        typed_schema::<SoulStylePackUninstallResponse>("SoulStylePackUninstallResponse"),
        ...
        typed_schema::<McpServerElicitationRequestParams>("McpServerElicitationRequestParams"),
        typed_schema::<McpServerElicitationAction>("McpServerElicitationAction"),
        typed_schema::<McpServerElicitationResponse>("McpServerElicitationResponse"),
        ...
        typed_schema::<McpResourceSubscribeParams>("McpResourceSubscribeParams"),
        typed_schema::<McpResourceUnsubscribeParams>("McpResourceUnsubscribeParams"),
        typed_schema::<McpResourceSubscriptionResponse>("McpResourceSubscriptionResponse"),
        ...
        typed_schema::<DiagnosticsTraceListParams>("DiagnosticsTraceListParams"),
        typed_schema::<DiagnosticsTraceReadParams>("DiagnosticsTraceReadParams"),
        typed_schema::<DiagnosticsTraceExportParams>("DiagnosticsTraceExportParams"),
        typed_schema::<DiagnosticsTraceRedactionPolicy>("DiagnosticsTraceRedactionPolicy"),
        typed_schema::<DiagnosticsTraceSummary>("DiagnosticsTraceSummary"),
        typed_schema::<DiagnosticsTraceEvent>("DiagnosticsTraceEvent"),
        typed_schema::<DiagnosticsTraceListResponse>("DiagnosticsTraceListResponse"),
        typed_schema::<DiagnosticsTraceReadResponse>("DiagnosticsTraceReadResponse"),
        typed_schema::<DiagnosticsTraceExportResponse>("DiagnosticsTraceExportResponse"),
        typed_schema::<SupportBundleTraceExportSelection>("SupportBundleTraceExportSelection"),
        typed_schema::<SupportBundleExportParams>("SupportBundleExportParams"),
        ...
        typed_schema::<AgentSessionRuntimeEventAppendParams>(
        ...
        typed_schema::<CanonicalThreadEventNotification>("CanonicalThreadEventNotification"),
        ...
        typed_schema::<WorkflowCancelParams>("WorkflowCancelParams"),
        typed_schema::<WorkflowCancelResponse>("WorkflowCancelResponse"),
        typed_schema::<WorkflowRetryParams>("WorkflowRetryParams"),
        typed_schema::<WorkflowRetryResponse>("WorkflowRetryResponse"),
        typed_schema::<WorkflowRespondParams>("WorkflowRespondParams"),
        typed_schema::<WorkflowRespondResponse>("WorkflowRespondResponse"),
        typed_schema::<AgentSessionEventParams>("AgentSessionEventParams"),
        typed_schema::<ThreadReadParams>("ThreadReadParams"),
        typed_schema::<ThreadReadResponse>("ThreadReadResponse"),
        typed_schema::<ThreadListParams>("ThreadListParams"),
        typed_schema::<ThreadListResponse>("ThreadListResponse"),
        typed_schema::<ThreadTurnsListParams>("ThreadTurnsListParams"),
        typed_schema::<ThreadTurnsListResponse>("ThreadTurnsListResponse"),
        typed_schema::<ThreadItemsListParams>("ThreadItemsListParams"),
        typed_schema::<ThreadItemsListResponse>("ThreadItemsListResponse"),
        ...
        typed_schema::<TestCaseStep>("TestCaseStep"),
        typed_schema::<TestCase>("TestCase"),
        typed_schema::<TestCaseModule>("TestCaseModule"),
        typed_schema::<TestCaseListParams>("TestCaseListParams"),
        typed_schema::<TestCaseListResponse>("TestCaseListResponse"),
        typed_schema::<TestCaseReadParams>("TestCaseReadParams"),
        typed_schema::<TestCaseReadResponse>("TestCaseReadResponse"),
        typed_schema::<TestCaseSaveParams>("TestCaseSaveParams"),
        typed_schema::<TestCaseSaveResponse>("TestCaseSaveResponse"),
        typed_schema::<TestCaseDeleteParams>("TestCaseDeleteParams"),
        typed_schema::<TestCaseDeleteResponse>("TestCaseDeleteResponse"),
        typed_schema::<TestCaseModuleListParams>("TestCaseModuleListParams"),
        typed_schema::<TestCaseModuleListResponse>("TestCaseModuleListResponse"),
        typed_schema::<TestCaseModuleSaveParams>("TestCaseModuleSaveParams"),
        typed_schema::<TestCaseModuleSaveResponse>("TestCaseModuleSaveResponse"),
        typed_schema::<TestCaseModuleDeleteParams>("TestCaseModuleDeleteParams"),
        typed_schema::<TestCaseModuleDeleteResponse>("TestCaseModuleDeleteResponse"),
        typed_schema::<TestCaseRunStep>("TestCaseRunStep"),
        typed_schema::<TestCaseRun>("TestCaseRun"),
        typed_schema::<TestCaseRunSaveParams>("TestCaseRunSaveParams"),
        typed_schema::<TestCaseRunSaveResponse>("TestCaseRunSaveResponse"),
        typed_schema::<TestCaseRunListParams>("TestCaseRunListParams"),
        typed_schema::<TestCaseRunListResponse>("TestCaseRunListResponse"),
        typed_schema::<PerfMetricSummary>("PerfMetricSummary"),
        typed_schema::<PerformanceSession>("PerformanceSession"),
        typed_schema::<PerfMonitorSessionSaveParams>("PerfMonitorSessionSaveParams"),
        typed_schema::<PerfMonitorSessionSaveResponse>("PerfMonitorSessionSaveResponse"),
        typed_schema::<PerfMonitorSessionListParams>("PerfMonitorSessionListParams"),
        typed_schema::<PerfMonitorSessionListResponse>("PerfMonitorSessionListResponse"),
        typed_schema::<PerfMonitorSessionReadParams>("PerfMonitorSessionReadParams"),
        typed_schema::<PerfMonitorSessionReadResponse>("PerfMonitorSessionReadResponse"),
        typed_schema::<PerformanceTraceArtifact>("PerformanceTraceArtifact"),
        typed_schema::<PerformanceTraceAnalysis>("PerformanceTraceAnalysis"),
        typed_schema::<PerfMonitorTraceSaveParams>("PerfMonitorTraceSaveParams"),
        typed_schema::<PerfMonitorTraceSaveResponse>("PerfMonitorTraceSaveResponse"),
        typed_schema::<PerfMonitorTraceListParams>("PerfMonitorTraceListParams"),
        typed_schema::<PerfMonitorTraceListResponse>("PerfMonitorTraceListResponse"),
        typed_schema::<PerfMonitorTraceReadParams>("PerfMonitorTraceReadParams"),
        typed_schema::<PerfMonitorTraceReadResponse>("PerfMonitorTraceReadResponse"),
        typed_schema::<PerfMonitorTraceDeleteParams>("PerfMonitorTraceDeleteParams"),
        typed_schema::<PerfMonitorTraceDeleteResponse>("PerfMonitorTraceDeleteResponse"),
        typed_schema::<PerfMonitorTraceAnalysisSaveParams>("PerfMonitorTraceAnalysisSaveParams"),
        typed_schema::<PerfMonitorTraceAnalysisSaveResponse>("PerfMonitorTraceAnalysisSaveResponse"),
        typed_schema::<PerfMonitorTraceAnalysisListParams>("PerfMonitorTraceAnalysisListParams"),
        typed_schema::<PerfMonitorTraceAnalysisListResponse>("PerfMonitorTraceAnalysisListResponse"),
        typed_schema::<FlowVlmAnchor>("FlowVlmAnchor"),
        typed_schema::<FlowLocator>("FlowLocator"),
        typed_schema::<FlowAssertion>("FlowAssertion"),
        typed_schema::<FlowWaitPolicy>("FlowWaitPolicy"),
        typed_schema::<FlowStep>("FlowStep"),
        typed_schema::<TestFlow>("TestFlow"),
        typed_schema::<FlowRun>("FlowRun"),
        typed_schema::<FlowLocatorRef>("FlowLocatorRef"),
        typed_schema::<FlowAssertResult>("FlowAssertResult"),
        typed_schema::<FlowRunStep>("FlowRunStep"),
        typed_schema::<HealingRevision>("HealingRevision"),
        typed_schema::<DeviceFlowListParams>("DeviceFlowListParams"),
        typed_schema::<DeviceFlowListResponse>("DeviceFlowListResponse"),
        typed_schema::<DeviceFlowReadParams>("DeviceFlowReadParams"),
        typed_schema::<DeviceFlowReadResponse>("DeviceFlowReadResponse"),
        typed_schema::<DeviceFlowSaveParams>("DeviceFlowSaveParams"),
        typed_schema::<DeviceFlowSaveResponse>("DeviceFlowSaveResponse"),
        typed_schema::<DeviceFlowDeleteParams>("DeviceFlowDeleteParams"),
        typed_schema::<DeviceFlowDeleteResponse>("DeviceFlowDeleteResponse"),
        typed_schema::<DeviceFlowRunSaveParams>("DeviceFlowRunSaveParams"),
        typed_schema::<DeviceFlowRunSaveResponse>("DeviceFlowRunSaveResponse"),
        typed_schema::<DeviceFlowRunListParams>("DeviceFlowRunListParams"),
        typed_schema::<DeviceFlowRunListResponse>("DeviceFlowRunListResponse"),
        typed_schema::<DeviceFlowRunReadParams>("DeviceFlowRunReadParams"),
        typed_schema::<DeviceFlowRunReadResponse>("DeviceFlowRunReadResponse"),
        typed_schema::<DeviceFlowHealingListParams>("DeviceFlowHealingListParams"),
        typed_schema::<DeviceFlowHealingListResponse>("DeviceFlowHealingListResponse"),
        typed_schema::<DeviceFlowHealingSaveParams>("DeviceFlowHealingSaveParams"),
        typed_schema::<DeviceFlowHealingSaveResponse>("DeviceFlowHealingSaveResponse"),
        typed_schema::<DeviceFlowHealingResolveParams>("DeviceFlowHealingResolveParams"),
        typed_schema::<DeviceFlowHealingResolveResponse>("DeviceFlowHealingResolveResponse"),
        typed_schema::<DeviceExploreProfile>("DeviceExploreProfile"),
        typed_schema::<DeviceExploreReadParams>("DeviceExploreReadParams"),
        typed_schema::<DeviceExploreReadResponse>("DeviceExploreReadResponse"),
        typed_schema::<DeviceExploreSaveParams>("DeviceExploreSaveParams"),
        typed_schema::<DeviceExploreSaveResponse>("DeviceExploreSaveResponse"),
        typed_schema::<ExploreRun>("ExploreRun"),
        typed_schema::<DeviceExploreRunSaveParams>("DeviceExploreRunSaveParams"),
        typed_schema::<DeviceExploreRunSaveResponse>("DeviceExploreRunSaveResponse"),
        typed_schema::<DeviceExploreRunListParams>("DeviceExploreRunListParams"),
        typed_schema::<DeviceExploreRunListResponse>("DeviceExploreRunListResponse"),
        typed_schema::<DeviceExploreRunReadParams>("DeviceExploreRunReadParams"),
        typed_schema::<DeviceExploreRunReadResponse>("DeviceExploreRunReadResponse"),
    ]
}
