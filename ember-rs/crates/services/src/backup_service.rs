...
use ember_core::database::{get_db_path, DbConnection};
...
impl BackupService {
    ...
    pub fn with_defaults() -> Result<Self, String> {
        ...
        let backup_dir = home.join(".ember").join("backups");
    ...
    pub fn backup_database(&self) -> Result<PathBuf, String> {
        ...
        let backup_path = self.backup_dir.join(format!("ember_{timestamp}.db"));
