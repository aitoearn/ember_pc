...
pub struct PluginManifest {
    ...
    /// 最低 Ember 版本要求
    #[serde(default)]
    pub min_ember_version: Option<String>,
    /// Binary 类型插件的扩展配置
    /// _需求: 5.2_
    #[serde(default)]
...
impl PluginInstance {
    ...
    pub fn info(&self) -> PluginInfo {
        ...
        PluginInfo {
            ...
            min_ember_version: manifest.min_ember_version.clone(),
...
mod tests {
    ...
    fn arb_plugin_manifest() -> impl Strategy<Value = PluginManifest> {
        (
            ...
            proptest::option::of("[0-9]{1,2}\\.[0-9]{1,2}\\.[0-9]{1,2}"), // min_ember_version
    ...
    fn test_plugin_manifest_with_binary_and_ui() {
        let manifest = PluginManifest {
            ...
            author: Some("Ember Team".to_string()),
            ...
            config_schema: None,
            hooks: vec![],
            min_ember_version: Some("1.0.0".to_string()),
