    ...
    fn audit_update_persists_evidence_fields() {
        ...
        let updated = update_objective_audit_by_owner(
            ...
            ManagedObjectiveAuditUpdate {
                ...
                last_evidence_pack_ref: Some(" .ember/harness/evidence ".to_string()),
                last_artifact_refs: vec![
                    " .ember/harness/evidence/artifacts/result.md ".to_string(),
                    " ".to_string(),
                ],
                blocker_reason: None,
            },
        ...
        assert_eq!(
            ...
            Some(".ember/harness/evidence")
        );
        assert_eq!(
            updated.last_artifact_refs,
            vec![".ember/harness/evidence/artifacts/result.md".to_string()]
        );
