...
/// # Examples
/// ```ignore
/// use ember_lib::config::expand_tilde;
///
/// let expanded = expand_tilde("~/.ember/auth");
/// // 返回类似 "/Users/username/.ember/auth" 的路径
/// ```
...
/// # Examples
/// ```ignore
/// use ember_lib::config::collapse_tilde;
///
/// let collapsed = collapse_tilde("/Users/username/.ember/auth");
/// // 返回 "~/.ember/auth"
/// ```
...
mod unit_tests {
    ...
    fn test_expand_tilde_with_path() {
        let expanded = expand_tilde("~/.ember/auth");
        let home = dirs::home_dir().expect("应该能获取主目录");
        assert_eq!(expanded, home.join(".ember/auth"));
    }
    ...
    fn test_collapse_tilde_with_subpath() {
        let home = dirs::home_dir().expect("应该能获取主目录");
        let path = home.join(".ember/auth");
        let collapsed = collapse_tilde(&path);
        assert_eq!(collapsed, "~/.ember/auth");
    }
    ...
    fn test_expand_collapse_roundtrip() {
        ...
        let original = "~/.ember/auth/token.json";
