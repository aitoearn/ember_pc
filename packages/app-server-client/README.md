...
`@embercloud/app-server-client` is the TypeScript client surface for independent apps
...
```ts
import { createAgentRuntimeClient } from "@embercloud/app-server-client";
...
This package does not import Ember Rust crates, Tauri commands, Aster DTOs, or
