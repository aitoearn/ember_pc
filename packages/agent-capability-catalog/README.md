# @embercloud/agent-capability-catalog

`@embercloud/agent-capability-catalog` 是共享 Agent Runtime capability 的 headless catalog。它把 Claw / Plugin / Product App 都要用到的能力 ID、alias、metadata contract 和 tool policy 输入收敛为纯 TypeScript 函数。
