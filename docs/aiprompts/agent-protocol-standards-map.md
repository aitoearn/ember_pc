...
| Ember 开发协议 | Ember 当前实现的命令、运行时、目录、UI、治理边界 | `docs/aiprompts/`、`docs/roadmap/`、代码契约测试 | 直接约束 Ember 源码、GUI、Electron/App Server/Rust/React 主链 |
| 路线图候选 | 已在 Ember 中出现稳定模式，但还没足够独立 | `docs/roadmap/` | 有多处实现压力，但标准边界仍需验证 |
