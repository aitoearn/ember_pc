...
最近一次只读刷新：2026-05-11 01:32。刷新只更新 `.ember/qc/*` sidecar 和 docs/tests 审计文档，不提交、不推送、不中断任何正在运行的 qcloop worker。当前权威机器审计见 `.ember/qc/agent-qc-audit-current.json`。

## 1. 目标拆解

本轮整体目标不是单纯新增文档，而是为 Ember 这个即将运营的 Agent 产品建立可由 Agent 自主执行的测试体系。成功标准如下：

1. `docs/tests/` 下有人读测试标准、P0 手册、Ember 示例计划和当前 blocker 记录。
...
| 要求                                                            | 具体证据                                                                                                                                                    | 当前状态                                                                                                                                                                                                                                                                                                                                                                                                                                                                        | 结论                                |
| --------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------- |
| `docs/tests` 下新增测试文档                                 | `docs/tests/ember-agent-autonomous-testing-plan.md`、`docs/tests/ember-agent-autonomous-test-execution-matrix.md`                                     | 已存在，覆盖风险地图、Agent 分工、组合测试、Phase 0-6、owner gate、P0 执行矩阵和失败回写                                                                                                                                                                                                                                                                                                                                                                                        | PASS                                |
| `docs/tests` 入口更新                                       | `docs/tests/README.md`                                                                                                                                  | 已加入 Ember 自主测试计划与执行矩阵                                                                                                                                                                                                                                                                                                                                                                                                                                              | PASS                                |
...
| Ember 落地计划                                                   | `docs/tests/ember-agent-qc-rollout-plan.md`                                                                                                              | 已存在                                                                                                                                                                                                                                                                                                                                                                                                                                                                          | PASS                                |
| 当前 blocker 记录                                               | `docs/tests/ember-agent-qc-current-blockers.md`                                                                                                          | 已记录 v3 / v4 / v5、官方 evidence fail、scenario blocker 和关闭条件                                                                                                                                                                                                                                                                                                                                                                                                            | PASS                                |
...
| 检查项                                    | 证据                                                                                                                                               | 当前状态                                                                                        |
| ----------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------- |
| `structured-evidence-contract`            | `docs/tests/ember-agent-qc-evidence-contract.md`、qcloop worker prompt、verifier prompt、`agent-qc:export-evidence`、`agent-qc:release-summary` | PASS：`doc=true worker=true verifier=true strictJson=true exporter=true release=true`           |
| `stale-owner-intervention-protocol`       | `docs/tests/ember-agent-qc-stale-owner-intervention.md`、`docs/tests/ember-agent-qc-qcloop-operations.md`                                    | PASS：已定义只读取证、owner 确认格式和 post-clear rerun runbook                                 |
...
只读新增 `.ember/qc/stale-owner-intervention-request.json`，并在 `docs/tests/ember-agent-qc-stale-owner-intervention.md` 中登记为机器可读决策包。该 JSON 汇总 job、active item、DB lease、PID、binary provenance、证据引用、禁止动作和确认文本；它只用于 owner 决策，不等于授权。本轮仍没有执行 kill / pause / interrupt / restart。
...
npm run agent-qc:release-summary -- --evidence ./.ember/qc/agent-qc-evidence.json --require-scenario-manifest docs/test/agent-qc-scenarios.manifest.json --require-risk P0 --tag local-agent-qc-audit --output ./.ember/qc/release-agent-qc.current-audit.md --check
```
