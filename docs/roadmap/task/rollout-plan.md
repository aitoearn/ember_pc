...
1. `TaskProfile / RoutingDecision / LimitState` 已进入 `turn_context.metadata.ember_runtime`
...
**防止 Ember 一步跳进“理想化全自动多模型”，而忽略当前最真实的单模型、服务模型设置和 OEM 约束主路径。**
