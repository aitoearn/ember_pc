...
```text
/Users/coso/Documents/dev/ai/aitoearn/ember_pc/docs/roadmap/agentapp
```

服务端 / Cloud / EmberCore 控制面文档在：

```text
/Users/coso/Documents/dev/ai/embercloud/embercore/docs/roadmap/agentapp
```
...
```text
rg "agent-app|AgentApp|agent_app" src ember-rs docs/roadmap/agentapp
```
