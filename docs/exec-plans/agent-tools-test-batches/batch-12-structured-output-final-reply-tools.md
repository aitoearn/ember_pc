...
- `current`
  - `ember-rs/src/agent_tools/catalog.rs` 中的 `StructuredOutput`
...
- `docs/exec-plans/agent-tools-test-batches/batch-12-structured-output-final-reply-tools.md`
...
npx prettier --check "docs/exec-plans/agent-tools-test-batches/README.md" "docs/exec-plans/agent-tools-test-batches/batch-12-structured-output-final-reply-tools.md" "src/components/agent/chat/utils/protocolResidue.test.ts" "src/components/agent/chat/utils/messageDisplaySanitizer.test.ts"
```
