...
1. `ember-rs/src/agent_tools/catalog.rs`
...
| `WebSearch / WebFetch / browser* / mcp__ember-browser__*`                                                   | current  | 03   | covered | 通用网页搜索、抓取、浏览器工具             |
...
| `ember_create_*_task / social_generate_cover_image / GenerateImage`                                         | current  | 10   | covered | 内容工作台与媒体任务                       |
| `ember_site_* / ember_search_web_images`                                                                     | current  | 11   | covered | Browser Assist / Site Tools                |
| `ember_run_service_skill`                                                                                   | compat   | 11   | covered | 只保留历史展示和恢复                       |
...
证据：`docs/exec-plans/agent-tools-test-batches/final-audit.md`
