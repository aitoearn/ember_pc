...
```bash
cargo test --manifest-path "ember-rs/Cargo.toml" tools::agent_control -- --nocapture
cargo test --manifest-path "ember-rs/Cargo.toml" tools::team_tools -- --nocapture
cargo test --manifest-path "ember-rs/Cargo.toml" tools::ask -- --nocapture
cargo test --manifest-path "ember-rs/Cargo.toml" tools::plan_mode_tool -- --nocapture
```
