...
```bash
cargo test --manifest-path "ember-rs/Cargo.toml" tools::bash -- --nocapture
cargo test --manifest-path "ember-rs/Cargo.toml" tools::task_output_tool -- --nocapture
cargo test --manifest-path "ember-rs/Cargo.toml" tools::task_stop_tool -- --nocapture
```
