...
export const LOCAL_DATA_SOURCE_SKILLS_DIR = join(
  REPO_ROOT,
  "ember-rs/crates/app-server/src/local_data_source/skills",
);
...
export const PLUGIN_WORKER_TURN_MAIN =
  "ember-rs/crates/app-server/src/runtime/plugin_worker_turn.rs";
export const PLUGIN_WORKER_TURN_SPLIT_MODULES = [
  "ember-rs/crates/app-server/src/runtime/plugin_worker_turn/failure.rs",
  "ember-rs/crates/app-server/src/runtime/plugin_worker_turn/hooks.rs",
  "ember-rs/crates/app-server/src/runtime/plugin_worker_turn/json_helpers.rs",
  "ember-rs/crates/app-server/src/runtime/plugin_worker_turn/launch_gate.rs",
  "ember-rs/crates/app-server/src/runtime/plugin_worker_turn/progress.rs",
  "ember-rs/crates/app-server/src/runtime/plugin_worker_turn/request.rs",
  "ember-rs/crates/app-server/src/runtime/plugin_worker_turn/tests.rs",
];
...
export const RUNTIME_BACKEND_TEST_SPLIT_MODULES = [
  ...
  "ember-rs/crates/app-server/src/runtime_backend/tests/image_tools.rs",
  "ember-rs/crates/app-server/src/runtime_backend/tests/model_selection.rs",
  "ember-rs/crates/app-server/src/runtime_backend/tests/session_prompt_context.rs",
  "ember-rs/crates/app-server/src/runtime_backend/tests/session_skill_context.rs",
  "ember-rs/crates/app-server/src/runtime_backend/tests/session_soul_context.rs",
  "ember-rs/crates/app-server/src/runtime_backend/tests/tool_inventory.rs",
...
export const IMAGE_COMMAND_MAIN =
  "ember-rs/crates/app-server/src/runtime_backend/image_command/mod.rs";
export const IMAGE_COMMAND_SPLIT_MODULES = [
  "ember-rs/crates/app-server/src/runtime_backend/image_command/events.rs",
  "ember-rs/crates/app-server/src/runtime_backend/image_command/intent.rs",
  "ember-rs/crates/app-server/src/runtime_backend/image_command/presentation.rs",
  "ember-rs/crates/app-server/src/runtime_backend/image_command/tests.rs",
];
export const RUNTIME_CORE_MAIN = "ember-rs/crates/app-server/src/runtime.rs";
export const RUNTIME_CORE_OWNER_MODULES = [
  "ember-rs/crates/app-server/src/runtime/context_compaction.rs",
  "ember-rs/crates/app-server/src/runtime/execution_request.rs",
  "ember-rs/crates/app-server/src/runtime/model_providers.rs",
  "ember-rs/crates/app-server/src/runtime/read_model.rs",
  "ember-rs/crates/app-server/src/runtime/session_control.rs",
  ...
  "ember-rs/crates/app-server/src/runtime/value_fields.rs",
];
...
export const RUNTIME_READ_MODEL_OWNER_MODULES = [
  ...
  "ember-rs/crates/app-server/src/runtime/coding_activity_projection.rs",
  "ember-rs/crates/app-server/src/runtime/file_checkpoint_projection.rs",
  "ember-rs/crates/app-server/src/runtime/permission_state_projection.rs",
  "ember-rs/crates/app-server/src/runtime/read_model/messages.rs",
  "ember-rs/crates/app-server/src/runtime/read_model/model_routing.rs",
  "ember-rs/crates/app-server/src/runtime/read_model/queued_turns.rs",
  "ember-rs/crates/app-server/src/runtime/read_model/runtime_items.rs",
  "ember-rs/crates/app-server/src/runtime/read_model/session_metadata.rs",
  "ember-rs/crates/app-server/src/runtime/read_model/tests.rs",
  "ember-rs/crates/app-server/src/runtime/read_model_turn_usage.rs",
  "ember-rs/crates/app-server/src/runtime/tool_item_projection.rs",
  "ember-rs/crates/app-server/src/runtime/workflow/read_model.rs",
];
export const RUNTIME_THREAD_ITEM_PROJECTION_MAIN =
  "ember-rs/crates/app-server/src/runtime/thread_item_projection.rs";
export const RUNTIME_THREAD_ITEM_PROJECTION_OWNER_MODULES = [
  "ember-rs/crates/app-server/src/runtime/thread_item_projection/agent_message.rs",
  "ember-rs/crates/app-server/src/runtime/thread_item_projection/plan.rs",
];
...
export const RUNTIME_BACKEND_OWNER_MODULES = [
  ...
  "ember-rs/crates/app-server/src/runtime_backend/model_capability.rs",
  "ember-rs/crates/app-server/src/runtime_backend/model_routing.rs",
...
export const AGENT_SESSION_EXECUTION_RUNTIME_MAIN =
  "ember-rs/crates/agent/src/session_execution_runtime.rs";
export const AGENT_SESSION_EXECUTION_RUNTIME_OWNER_MODULES = [
  "ember-rs/crates/agent/src/agent_tools/execution.rs",
  ...
  "ember-rs/crates/agent/src/turn_input_envelope.rs",
];
export const PROCESSOR_MAIN = "ember-rs/crates/app-server/src/processor/mod.rs";
export const PROCESSOR_DISPATCH =
  "ember-rs/crates/app-server/src/processor/dispatch.rs";
export const PROCESSOR_TESTS_MAIN =
  "ember-rs/crates/app-server/src/processor/tests.rs";
export const PROCESSOR_SPLIT_MODULES = [
  "ember-rs/crates/app-server/src/processor/dispatch.rs",
  "ember-rs/crates/app-server/src/processor/tests/artifact.rs",
  "ember-rs/crates/app-server/src/processor/tests/capability.rs",
  "ember-rs/crates/app-server/src/processor/tests/evidence.rs",
  "ember-rs/crates/app-server/src/processor/tests/execution_process.rs",
  "ember-rs/crates/app-server/src/processor/tests/file.rs",
  "ember-rs/crates/app-server/src/processor/tests/mcp.rs",
  "ember-rs/crates/app-server/src/processor/tests/project_git.rs",
  "ember-rs/crates/app-server/src/processor/tests/right_surface.rs",
  "ember-rs/crates/app-server/src/processor/tests/usage_stats.rs",
];
...
export const EXTERNAL_BACKEND_SCAN_DIRS = [
  ...
  "scripts",
  "ember-rs/crates/app-server/src",
  "ember-rs/crates/app-server-daemon/src",
];

export const ALLOWED_AGENT_COUPLING_OWNER_FILES = new Set([
  "ember-rs/crates/app-server/src/agent_runtime_registry.rs",
  "ember-rs/crates/app-server/src/runtime_backend.rs",
  "ember-rs/crates/app-server/src/runtime_backend/action_response.rs",
  "ember-rs/crates/app-server/src/runtime_backend/image_tools.rs",
  "ember-rs/crates/app-server/src/runtime_backend/live_execution_process.rs",
  "ember-rs/crates/app-server/src/runtime_backend/mcp_bridges.rs",
  "ember-rs/crates/app-server/src/runtime_backend/memory_tools.rs",
  "ember-rs/crates/app-server/src/runtime_backend/native_tools.rs",
...
export const ALLOWED_EXTERNAL_BACKEND_LAUNCH_FILES = new Set([
  ...
  "ember-rs/crates/app-server-daemon/src/lib.rs",
