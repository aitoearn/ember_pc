...
const RUST_CANONICAL_MODEL_SOURCE =
  "ember-rs/crates/model-provider/src/canonical/model.rs";
const RUST_CANONICAL_REGISTRY_SOURCE =
  "ember-rs/crates/model-provider/src/canonical/registry.rs";
const SCAN_ROOTS = ["src", "packages", "ember-rs/crates"];
