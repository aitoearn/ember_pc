...
const AGENT_LIB_RS = join(REPO_ROOT, "ember-rs/crates/agent/src/lib.rs");
const LEGACY_PERMISSION_FIXTURE_RS = join(
  REPO_ROOT,
  "ember-rs/crates/agent/tests/legacy_permission_surfaces.rs",
);
const RUST_SCAN_ROOTS = [join(REPO_ROOT, "ember-rs/crates")];
