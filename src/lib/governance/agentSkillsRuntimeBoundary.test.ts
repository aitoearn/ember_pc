...
const RUNTIME_BACKEND_DIR = join(
  REPO_ROOT,
  "ember-rs/crates/app-server/src/runtime_backend",
);
const AGENT_SRC_DIR = join(REPO_ROOT, "ember-rs/crates/agent/src");

const SNAPSHOT_OWNER_FILES = new Set([
  "ember-rs/crates/app-server/src/runtime_backend/agent_skills_context.rs",
  "ember-rs/crates/app-server/src/runtime_backend/agent_skills_telemetry.rs",
]);

const SKILL_GATE_OWNER_FILES = new Set([
  "ember-rs/crates/app-server/src/runtime_backend/skill_runtime_enable.rs",
]);

const SKILL_TOOL_WRAPPER_OWNER =
  "ember-rs/crates/agent/src/tools/skill_tool_gate.rs";
const SKILL_SEARCH_TOOL_OWNER =
  "ember-rs/crates/tool-runtime/src/skill_search.rs";
