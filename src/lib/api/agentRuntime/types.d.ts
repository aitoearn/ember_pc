 ...
 */
import type { AgentContextBudget, AgentMessage, AgentMissingContextFact, AgentRetrievalRef, AgentTeamMemoryRef, AgentThreadItem, AgentThreadTurn } from "../agentProtocol";
import type { AsterApprovalPolicy, AsterExecutionStrategy, AsterSandboxPolicy, AsterSessionExecutionRuntimeCostState, AsterSessionExecutionRuntimeLimitEvent, AsterSessionExecutionRuntime, AsterSessionExecutionRuntimeAccessMode, AsterSessionExecutionRuntimeLimitState, AsterSessionExecutionRuntimePermissionState, AsterSessionExecutionRuntimePreferences, AsterSessionExecutionRuntimeRecentTeamSelection } from "../agentExecutionRuntime";
...
export type ManagedObjectiveStatus = "active" | "verifying" | "needs_input" | "blocked" | "budget_limited" | "paused" | "completed" | "failed";
...
export type AgentRuntimeProfileStatus = "idle" | "queued" | "running" | "blocked" | "completed" | "failed" | "cancelled" | "stale" | "unknown";
...
export interface AgentRuntimeSummary {
    ...
    quotaLow?: boolean | null;
    embercorePolicy?: AgentRuntimeThreadEmberCorePolicySummary | null;
}
export interface AgentRuntimeThreadEmberCorePolicySummary {
    ...
    source?: string | null;
    evaluation?: AgentRuntimeThreadEmberCorePolicyEvaluation | null;
}
export interface AgentRuntimeThreadEmberCorePolicyEvaluation {
    status?: string | null;
    decision?: string | null;
    decisionSource?: string | null;
    decisionScope?: string | null;
...
export interface AsterSubagentSessionInfo {
    ...
    runtime_status?: "idle" | "queued" | "running" | "completed" | "failed" | "aborted" | "closed";
    latest_turn_status?: "idle" | "queued" | "running" | "completed" | "failed" | "aborted" | "closed";
...
export type AgentRuntimeHandoffArtifactKind = "plan" | "progress" | "handoff" | "review_summary";
...
export type AgentRuntimeEvidenceArtifactKind = "summary" | "runtime" | "timeline" | "artifacts";
...
export type AgentRuntimeEvidenceVerificationOutcome = "success" | "blocking_failure" | "advisory_failure" | "recovered";
...
export interface AgentRuntimeEvidenceEmberCorePolicyItem {
    artifact_path?: string;
    contract_key?: string;
    ...
    policy_inputs?: AgentRuntimeEvidenceEmberCorePolicyInput[];
    pending_hit_refs?: string[];
    policy_value_hits?: AgentRuntimeEvidenceEmberCorePolicyValueHit[];
    policy_value_hit_count?: number;
    policy_evaluation?: AgentRuntimeEvidenceEmberCorePolicyEvaluation;
    source?: string;
}
export interface AgentRuntimeEvidenceEmberCorePolicyEvaluation {
    status?: string;
    decision?: string;
    decision_source?: string;
    decision_scope?: string;
...
export interface AgentRuntimeEvidenceEmberCorePolicyInput {
    ref_key: string;
    status?: string;
    source?: string;
    value_source?: string;
}
export interface AgentRuntimeEvidenceEmberCorePolicyValueHit {
    ref_key: string;
    status?: string;
    source?: string;
    value_source?: string;
...
export interface AgentRuntimeEvidenceEmberCorePolicyIndex {
    snapshot_count: number;
    ref_keys: string[];
    missing_inputs?: string[];
    pending_hit_refs?: string[];
    ...
    items: AgentRuntimeEvidenceEmberCorePolicyItem[];
}
export interface AgentRuntimeEvidenceSnapshotIndex {
    ...
    embercore_policy_index?: AgentRuntimeEvidenceEmberCorePolicyIndex;
}
...
export type AgentRuntimeRequestedFixExecutionStatus = "pending" | "assigned" | "running" | "completed" | "failed" | "blocked" | "cancelled";
...
export type AgentRuntimeReplayArtifactKind = "input" | "expected" | "grader" | "evidence_links";
...
export type AgentRuntimeAnalysisArtifactKind = "analysis_brief" | "analysis_context";
...
export type AgentRuntimeReviewDecisionArtifactKind = "review_decision_markdown" | "review_decision_json";
export type AgentRuntimeReviewDecisionStatus = "accepted" | "deferred" | "rejected" | "needs_more_evidence" | "pending_review";
export type AgentRuntimeReviewDecisionRiskLevel = "low" | "medium" | "high" | "unknown";
...
export type AgentRuntimeFrontmatterHooks = Partial<Record<string, AgentRuntimeFrontmatterHookMatcher[]>>;
...
export interface AgentRuntimeStatusSnapshot {
    session_id: string;
    kind: "idle" | "queued" | "running" | "completed" | "failed" | "aborted" | "closed" | "not_found";
    latest_turn_id?: string;
    latest_turn_status?: "idle" | "queued" | "running" | "completed" | "failed" | "aborted" | "closed" | "not_found";
    queued_turn_count?: number;
    closed?: boolean;
}
...
export interface MediaTaskModalityRuntimeContractIndexEntry {
    ...
    embercore_policy_snapshot_status?: string | null;
    embercore_policy_decision?: string | null;
    embercore_policy_decision_source?: string | null;
    embercore_policy_decision_scope?: string | null;
    embercore_policy_decision_reason?: string | null;
    embercore_policy_evaluation_status?: string | null;
    embercore_policy_evaluation_decision?: string | null;
    embercore_policy_evaluation_decision_source?: string | null;
    embercore_policy_evaluation_decision_scope?: string | null;
    embercore_policy_evaluation_decision_reason?: string | null;
    embercore_policy_evaluation_blocking_refs?: string[];
    embercore_policy_evaluation_ask_refs?: string[];
    embercore_policy_evaluation_pending_refs?: string[];
    embercore_policy_unresolved_refs?: string[];
    embercore_policy_missing_inputs?: string[];
    embercore_policy_pending_hit_refs?: string[];
    embercore_policy_value_hits?: unknown[];
    embercore_policy_value_hit_count?: number;
...
export interface MediaTaskEmberCorePolicySnapshotStatusCount {
    status: string;
    count: number;
}
export interface MediaTaskEmberCorePolicyEvaluationStatusCount {
    status: string;
    count: number;
}
export interface MediaTaskModalityRuntimeContractIndex {
    ...
    executor_binding_keys?: string[];
    embercore_policy_refs: string[];
    embercore_policy_snapshot_count: number;
    embercore_policy_snapshot_statuses: MediaTaskEmberCorePolicySnapshotStatusCount[];
    embercore_policy_decisions: string[];
    embercore_policy_decision_sources?: string[];
    embercore_policy_evaluation_statuses?: MediaTaskEmberCorePolicyEvaluationStatusCount[];
    embercore_policy_evaluation_decisions?: string[];
    embercore_policy_evaluation_decision_sources?: string[];
    embercore_policy_evaluation_blocking_refs?: string[];
    embercore_policy_evaluation_ask_refs?: string[];
    embercore_policy_evaluation_pending_refs?: string[];
    embercore_policy_unresolved_refs?: string[];
...
export type AgentToolCapability = "planning" | "delegation" | "web_search" | "skill_execution" | "session_control" | "content_creation" | "browser_runtime" | "workspace_io" | "execution" | "vision";
export type AgentToolLifecycle = "current" | "compat" | "deprecated";
export type AgentToolSourceKind = "aster_builtin" | "ember_injected" | "browser_compatibility";
export type AgentToolPermissionPlane = "session_allowlist" | "parameter_restricted" | "caller_filtered";
export type AgentToolExecutionWarningPolicy = "none" | "shell_command_risk";
export type AgentToolExecutionRestrictionProfile = "none" | "workspace_path_required" | "workspace_path_optional" | "workspace_absolute_path_required" | "workspace_shell_command" | "analyze_image_input" | "safe_https_url_required";
export type AgentToolExecutionSandboxProfile = "none" | "workspace_command";
export type AgentToolExecutionPolicySource = "default" | "persisted" | "runtime";
export type AgentRuntimeExtensionSourceKind = "mcp_bridge" | "runtime_extension";
export type AgentRuntimeToolInventoryRuntimeSourceKind = "registry_native" | "current_surface" | "runtime_extension" | "mcp";
...
export type AgentRuntimeWorkspaceSkillBindingStatus = "ready_for_manual_enable" | "blocked";
