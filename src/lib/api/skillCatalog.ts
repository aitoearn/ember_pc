...
const SKILL_CATALOG_STORAGE_KEY = "ember:skill-catalog:v1";
const LOCAL_MODEL_BOUND_IMAGE_COMMAND_STORAGE_KEY =
  "ember:local-direct-image-commands:v1";
export const SKILL_CATALOG_CHANGED_EVENT = "ember:skill-catalog-changed";
