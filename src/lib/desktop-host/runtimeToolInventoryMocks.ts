...
const WORKBENCH_MOCK_TOOL_SPECS: MockToolSpec[] = [
  ...
  {
    name: "ember_create_transcription_task",
    description: "创建转写任务。",
    capabilities: ["content_creation"],
    source: "ember_injected",
  ...
  {
    name: "ember_create_broadcast_generation_task",
    description: "发起口播生成。",
    capabilities: ["content_creation"],
    source: "ember_injected",
  ...
  {
    name: "ember_create_cover_generation_task",
    description: "发起封面生成。",
    capabilities: ["content_creation"],
    source: "ember_injected",
    tags: ["content", "image", "cover"],
  ...
  {
    name: "ember_create_url_parse_task",
  ...
  {
    name: "ember_create_typesetting_task",
    description: "创建排版任务。",
    capabilities: ["content_creation"],
    source: "ember_injected",
...
function buildMockAgentRuntimeToolInventory(request?: {
  ...
  const mcpTools = surface.browser_assist
    ? listEnabledBrowserAssistCapabilities().map((capability) => {
        ...
        return {
          ...
          name: `mcp__ember-browser__${capability.key}`,
  ...
  return {
    ...
    mcp_servers: surface.browser_assist ? ["ember-browser"] : [],
