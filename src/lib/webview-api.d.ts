...
export declare function saveBrowserEnvironmentPreset(
  request: SaveBrowserEnvironmentPresetRequest,
): Promise<BrowserEnvironmentPresetRecord>;
export declare function archiveBrowserEnvironmentPreset(
  id: string,
): Promise<boolean>;
export declare function restoreBrowserEnvironmentPreset(
  id: string,
): Promise<boolean>;
...
export declare function setBrowserConnectorInstallRoot(
  installRootDir: string,
): Promise<BrowserConnectorSettingsSnapshot>;
export declare function setBrowserConnectorEnabled(
  enabled: boolean,
): Promise<BrowserConnectorSettingsSnapshot>;
...
export declare function installBrowserConnectorExtension(
 ...
 */
export declare function chromeBridgeExecuteCommand(
...
export declare function stopBrowserStream(
  sessionId: string,
): Promise<CdpSessionState>;
export declare function getBrowserSessionState(
  sessionId: string,
): Promise<CdpSessionState>;
export declare function takeOverBrowserSession(
  request: UpdateBrowserSessionControlRequest,
): Promise<CdpSessionState>;
export declare function releaseBrowserSession(
  request: UpdateBrowserSessionControlRequest,
): Promise<CdpSessionState>;
export declare function resumeBrowserSession(
  request: UpdateBrowserSessionControlRequest,
): Promise<CdpSessionState>;
...
export declare function launchBrowserSession(
  request: LaunchBrowserSessionRequest,
): Promise<BrowserSessionLaunchResponse>;
export declare function browserExecuteAction(
  request: BrowserActionRequest,
): Promise<BrowserActionResult>;
export declare function siteListAdapters(): Promise<SiteAdapterDefinition[]>;
export declare function siteRecommendAdapters(
  limit?: number,
): Promise<SiteAdapterRecommendation[]>;
export declare function siteSearchAdapters(
  query: string,
): Promise<SiteAdapterDefinition[]>;
export declare function siteGetAdapterInfo(
  name: string,
): Promise<SiteAdapterDefinition>;
export declare function siteGetAdapterLaunchReadiness(
