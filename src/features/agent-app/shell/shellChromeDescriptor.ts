  ...
  return {
    ...
    menu: {
      ...
      items: [
        {
          id: "about",
          labelKey: "agentApp.shell.menu.about",
          action: "about_app",
        },
        {
          id: "open",
          labelKey: "agentApp.shell.menu.open",
          action: "open_primary_entry",
        },
        {
          id: "check_updates",
          labelKey: "agentApp.shell.menu.checkUpdates",
          action: "check_updates",
        },
        {
          id: "quit",
          labelKey: "agentApp.shell.menu.quit",
          action: "quit_app",
        },
      ],
    },
...
export function validateShellChromeDescriptor(
  ...
  if (descriptor.constraints.runtimeBypass) {
    issues.push({
      ...
      message: "Standalone shell chrome must not bypass Ember Runtime governance.",
    });
  }
