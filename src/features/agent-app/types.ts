...
export type EmberRuntimeShellKind =
  | "desktop"
  | "app_shell"
  | "runtime_backed"
  | "web_host";

export interface EmberRuntimeProfileCapability {
  version: string;
  available: boolean;
  reason?: string;
...
export interface EmberRuntimeProfile {
  runtimeId: string;
  runtimeVersion: string;
  shellKind: EmberRuntimeShellKind;
  installMode: AgentAppInstallMode;
  capabilities: Record<string, EmberRuntimeProfileCapability>;
  policy: {
