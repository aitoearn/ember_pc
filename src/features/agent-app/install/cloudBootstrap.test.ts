    ...
    apps: [
      {
        ...
        displayName: "测试工作台",
        version: "0.3.0",
        logo: "https://assets.embercloud.example/content-factory-logo.png",
        presentation: {
          logo: "https://assets.embercloud.example/content-factory-presentation-logo.png",
        },
...
describe("Cloud Bootstrap payload P5.1", () => {
  it("应解析 EmberCore bootstrap payload 并映射为 cloud_release package identity", () => {
