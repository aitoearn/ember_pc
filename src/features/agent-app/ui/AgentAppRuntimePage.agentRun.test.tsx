...
describe("AgentAppRuntimePage Host AI run surface", () => {
  ...
  it("App 可通过 ember.ui 打开、更新并关闭 Host 级 AI 运行面板", async () => {
    ...
    expect(container.textContent).toContain("正在调用测试工作台写作 Skill");
