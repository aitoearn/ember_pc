...
describe("AgentRunProjectionPanel", () => {
  ...
  it("把 Artifact 和 Evidence refs 渲染为独立卡片", () => {
    const container = renderPanel([
      {
        ...
        payload: {
          artifact: {
            ...
            file_path: ".ember/artifacts/content-batch.json",
          },
        },
      },
      {
    ...
    expect(container.textContent).toContain(".ember/artifacts/content-batch.json");
    ...
    ).toBe("evidence:.ember/artifacts/content-batch.json");
  });
