...
import { buildEmberRuntimeProfileForInstalledState } from "../runtime-profile";
...
export function AgentAppsPage({
  ...
  const handleLaunchEntry = useCallback(
    async (state: InstalledAgentAppState, entry: ProjectedEntry) => {
      ...
      await runBusy(`launch:${state.appId}:${entry.key}`, async () => {
        ...
        const runtimeProfile = buildEmberRuntimeProfileForInstalledState({
          state,
          hostProfile,
        });
  ...
  function renderRegistrationForm(app: CloudBootstrapApp) {
    return (
      <div
        className="rounded-lg border border-[color:var(--ember-info-border)] bg-[color:var(--ember-info-soft)] px-4 py-3"
        data-testid={`agent-apps-registration-${app.appId}`}
      >
        <p className="text-xs font-semibold text-[color:var(--ember-text-strong)]">
        ...
        <div className="mt-3 flex gap-2">
          <input
            className="min-w-0 flex-1 rounded-full border border-[color:var(--ember-surface-border)] bg-[color:var(--ember-surface)] px-3 py-2 text-xs text-[color:var(--ember-text-strong)] outline-none transition focus:border-[color:var(--ember-surface-border-strong)]"
          ...
          <button
            type="button"
            className="shrink-0 rounded-full bg-[color:var(--ember-text-strong)] px-3 py-2 text-xs font-medium text-[color:var(--ember-surface)] transition hover:opacity-90 disabled:cursor-not-allowed disabled:opacity-60"
  ...
  function renderAppIcon(
    ...
    return (
      <div
        className={`overflow-hidden rounded-xl border border-[color:var(--ember-surface-border)] bg-[color:var(--ember-surface-soft)] ${className}`}
        data-testid={testId}
      >
        <img
    ...
    return (
      ...
      >
        <section
          role="dialog"
          aria-modal="true"
          className="ember-workbench-surface-scope flex max-h-[calc(100vh-3rem)] w-full max-w-[560px] flex-col overflow-hidden rounded-[18px] border border-[color:var(--ember-surface-border)] bg-[color:var(--ember-surface)] text-[color:var(--ember-text)] shadow-2xl shadow-slate-950/20"
        ...
        >
          <div className="min-h-0 flex-1 overflow-y-auto px-5 py-5">
            <div className="flex items-start justify-between gap-3">
              <div className="min-w-0">
                <p className="text-sm font-semibold text-[color:var(--ember-text-strong)]">
                  {t("agentApp.apps.installReview.title")}
                </p>
                <p className="mt-1 text-sm leading-6 text-[color:var(--ember-text-muted)]">
                  {t("agentApp.apps.installReview.description")}
                </p>
              </div>
              <button
                type="button"
                className="inline-flex h-9 shrink-0 items-center justify-center rounded-full border border-[color:var(--ember-surface-border)] bg-[color:var(--ember-surface)] px-3 text-sm font-medium text-[color:var(--ember-text-muted)] shadow-none transition hover:bg-[color:var(--ember-surface-hover)] hover:text-[color:var(--ember-text-strong)]"
            ...
            <div className="mt-4 rounded-lg border border-[color:var(--ember-info-border)] bg-[color:var(--ember-info-soft)] p-4">
              <div className="flex items-start justify-between gap-3">
                <div className="flex min-w-0 items-start gap-3">
                  <div
                    className="size-12 shrink-0 overflow-hidden rounded-xl border border-[color:var(--ember-surface-border)] bg-[color:var(--ember-surface-soft)]"
                  ...
                  <div className="min-w-0">
                    <p className="truncate text-base font-semibold text-[color:var(--ember-text-strong)]">
                      {installReview.review.displayName}
                    </p>
                    <p className="mt-1 text-sm text-[color:var(--ember-text-muted)]">
              ...
              <p className="mt-3 text-sm leading-6 text-[color:var(--ember-text)]">
          ...
          <div className="flex flex-wrap gap-2 border-t border-[color:var(--ember-surface-border)] bg-[color:var(--ember-surface)] px-5 py-4">
            <button
              type="button"
              className="inline-flex h-10 flex-1 items-center justify-center gap-2 rounded-full bg-[color:var(--ember-text-strong)] px-4 text-sm font-semibold text-[color:var(--ember-surface)] transition hover:opacity-90 disabled:cursor-not-allowed disabled:opacity-60"
              disabled={Boolean(busyAction)}
            ...
            <button
              type="button"
              className="inline-flex h-10 items-center justify-center rounded-full border border-[color:var(--ember-surface-border)] bg-[color:var(--ember-surface)] px-4 text-sm font-semibold text-[color:var(--ember-text)] transition hover:bg-[color:var(--ember-surface-hover)] disabled:cursor-not-allowed disabled:opacity-60"
              disabled={Boolean(busyAction)}
              onClick={() => setInstallReview(null)}
  ...
  return (
    <div
      className="ember-workbench-theme-scope flex h-full min-h-0 flex-col overflow-hidden bg-[color:var(--ember-app-bg)] text-[color:var(--ember-text)]"
      data-testid="agent-apps-page"
    >
      <div className="min-h-0 flex-1 overflow-auto bg-[color:var(--ember-surface)] px-5 pb-10 pt-10">
        <div className="mx-auto flex w-full max-w-[1040px] flex-col gap-8">
          <header className="flex flex-col gap-5 lg:flex-row lg:items-start lg:justify-between">
            <div className="min-w-0">
              <h1 className="text-[28px] font-semibold text-[color:var(--ember-text-strong)]">
                {t("agentApp.apps.center.title")}
              </h1>
              <p className="mt-2 max-w-xl text-sm leading-6 text-[color:var(--ember-text-muted)]">
            ...
            <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
              <label className="relative w-full sm:w-[360px]">
                <Search
                  className="pointer-events-none absolute left-4 top-1/2 -translate-y-1/2 text-[color:var(--ember-text-muted)]"
                  size={18}
                />
                <input
                  className="h-9 w-full rounded-full border border-[color:var(--ember-surface-border)] bg-[color:var(--ember-surface)] pl-10 pr-4 text-sm font-semibold text-[color:var(--ember-text-strong)] shadow-none outline-none transition placeholder:text-[color:var(--ember-text-muted)] focus:border-[color:var(--ember-surface-border-strong)]"
                  value={searchQuery}
              ...
              <div className="flex gap-3">
                <button
                  type="button"
                  className="inline-flex h-9 items-center gap-2 rounded-full bg-[color:var(--ember-text-strong)] px-5 text-sm font-semibold text-[color:var(--ember-surface)] shadow-none transition hover:opacity-90 disabled:cursor-not-allowed disabled:opacity-60"
                  disabled={Boolean(busyAction)}
                ...
                <button
                  type="button"
                  className="inline-flex h-9 items-center gap-2 rounded-full border border-[color:var(--ember-surface-border)] bg-[color:var(--ember-surface)] px-4 text-sm font-semibold text-[color:var(--ember-text-strong)] shadow-none transition hover:bg-[color:var(--ember-surface-hover)] disabled:cursor-not-allowed disabled:opacity-60"
              ...
              (filter) => (
                <button
                  ...
                  className={`inline-flex h-8 items-center gap-2 rounded-full text-base font-semibold transition ${
                    statusFilter === filter
                      ? "text-[color:var(--ember-text-strong)]"
                      : "text-[color:var(--ember-text-muted)] hover:text-[color:var(--ember-text-strong)]"
                  }`}
                  onClick={() => setStatusFilter(filter)}
                  data-testid={`agent-apps-status-filter-${filter}`}
                >
                  {t(`agentApp.apps.center.filter.${filter}`)}
                  <span className="text-xs text-[color:var(--ember-text-muted)]">
                    {filterCounts[filter]}
                  </span>
                </button>
              ),
          ...
          <section className="space-y-4">
            <div className="flex flex-wrap items-center justify-between gap-3 text-sm text-[color:var(--ember-text-muted)]">
                ...
                {(["all", "cloud", "local"] as const).map((filter) => (
                  <button
                    ...
                    className={`h-8 rounded-lg border px-3 text-xs font-semibold transition ${
                      sourceFilter === filter
                        ? "border-[color:var(--ember-surface-border-strong)] bg-[color:var(--ember-surface-hover)] text-[color:var(--ember-text-strong)]"
                        : "border-[color:var(--ember-surface-border)] bg-[color:var(--ember-surface)] text-[color:var(--ember-text)] hover:bg-[color:var(--ember-surface-hover)]"
                    }`}
              ...
              <div className="flex flex-wrap items-center gap-3">
                ...
                <button
                  type="button"
                  className="font-medium text-[color:var(--ember-text-muted)] hover:text-[color:var(--ember-text-strong)]"
              ...
              <div className="text-[color:var(--ember-text-muted)]">
                {t("agentApp.apps.center.sort.label")}：
                <span className="ml-2 font-medium text-[color:var(--ember-text)]">
            ...
            <main className="min-w-0">
              ...
              >
                {pagedItems.map((item) => {
                  ...
                  return (
                    <div
                      key={item.appId}
                      className={`group flex min-h-[188px] flex-col rounded-[10px] border bg-[color:var(--ember-surface)] p-4 text-left shadow-sm shadow-[color:var(--ember-shadow-color)] transition hover:border-[color:var(--ember-surface-border-strong)] hover:bg-[color:var(--ember-surface-hover)] hover:shadow-md ${
                        selectedRow
                    ...
                    >
                      <div className="flex min-w-0 items-start gap-3">
                        ...
                        <div className="min-w-0 flex-1">
                          <div className="flex min-w-0 items-start justify-between gap-3">
                            <h2 className="min-w-0 truncate text-sm font-semibold text-[color:var(--ember-text-strong)]">
                              {item.title}
                            </h2>
                            <span
                      ...
                      <p className="mt-3 line-clamp-2 min-h-[40px] text-sm leading-5 text-[color:var(--ember-text-muted)]">
                        {item.description ||
                      ...
                      <div className="mt-3 border-t border-[color:var(--ember-surface-border)] pt-3">
                        <div className="text-xs text-[color:var(--ember-text-muted)]">
                          <span className="font-medium text-[color:var(--ember-text)]">
                      ...
                      <div className="mt-auto flex items-center gap-2 pt-3">
                        <button
                          type="button"
                          className="inline-flex h-8 flex-1 min-w-0 items-center justify-center gap-2 rounded-full bg-[color:var(--ember-text-strong)] px-3 text-xs font-semibold text-[color:var(--ember-surface)] transition hover:opacity-90 disabled:cursor-not-allowed disabled:opacity-60"
                        ...
                        <button
                          type="button"
                          className="inline-flex h-8 shrink-0 items-center justify-center rounded-full border border-[color:var(--ember-surface-border)] bg-[color:var(--ember-surface)] px-3 text-xs font-semibold text-[color:var(--ember-text)] transition hover:bg-[color:var(--ember-surface-hover)]"
                      ...
                      hasCloudUpdate(item) ? (
                        <button
                          type="button"
                          className="mt-2 inline-flex h-8 w-full items-center justify-center rounded-full border border-[color:var(--ember-surface-border)] bg-[color:var(--ember-surface)] px-3 text-xs font-semibold text-[color:var(--ember-text)] transition hover:bg-[color:var(--ember-surface-hover)] disabled:cursor-not-allowed disabled:opacity-60"
                          disabled={
                            canOneClickUpdate(item)
                ...
                {pagedItems.length === 0 ? (
                  <div className="col-span-full flex min-h-[260px] items-center justify-center rounded-lg border border-dashed border-[color:var(--ember-surface-border)] bg-[color:var(--ember-surface-soft)] px-4 py-8 text-center">
                    <div>
                      <p className="text-sm font-semibold text-[color:var(--ember-text-strong)]">
                        {appItems.length === 0
                      ...
                      <p className="mt-2 text-sm text-[color:var(--ember-text-muted)]">
              ...
              <div className="mt-4 flex flex-wrap items-center justify-between gap-3 border-t border-[color:var(--ember-surface-border)] pt-4">
                <p className="text-xs text-[color:var(--ember-text-muted)]">
                ...
                <div className="flex gap-2">
                  <button
                    type="button"
                    className="inline-flex h-8 items-center gap-1 rounded-full border border-[color:var(--ember-surface-border)] bg-[color:var(--ember-surface)] px-4 text-sm font-medium text-[color:var(--ember-text)] transition hover:bg-[color:var(--ember-surface-hover)] disabled:cursor-not-allowed disabled:opacity-50"
          ...
          {selectedItem ? (
            ...
            >
              <section
                role="dialog"
                aria-modal="true"
                className="ember-workbench-surface-scope flex max-h-[calc(100vh-3rem)] min-h-[420px] w-full max-w-[920px] flex-col overflow-hidden rounded-[18px] border border-[color:var(--ember-surface-border)] bg-[color:var(--ember-surface)] text-[color:var(--ember-text)] shadow-2xl shadow-slate-950/20"
                ...
                <div className="min-h-0 flex-1 space-y-5 overflow-y-auto px-6 py-5">
                  <div className="space-y-4">
                    <div className="flex items-start gap-4">
                      ...
                      <div className="min-w-0 flex-1">
                        <p className="text-xs font-semibold text-[color:var(--ember-text-muted)]">
                          {t("agentApp.apps.center.detail.title")}
                        </p>
                        <h2 className="mt-2 text-[22px] font-semibold text-[color:var(--ember-text-strong)]">
                          {selectedItem.title}
                        </h2>
                    ...
                    <p className="text-sm leading-6 text-[color:var(--ember-text-muted)]">
                      {selectedItem.description ||
                        t("agentApp.apps.center.descriptionFallback")}
                    </p>
                    <button
                      type="button"
                      className="inline-flex h-10 w-full items-center justify-center gap-2 rounded-full bg-[color:var(--ember-text-strong)] px-3 text-sm font-semibold text-[color:var(--ember-surface)] transition hover:opacity-90 disabled:cursor-not-allowed disabled:opacity-80"
                    ...
                    hasCloudUpdate(selectedItem) ? (
                      <button
                        type="button"
                        className="inline-flex h-10 w-full items-center justify-center rounded-full border border-[color:var(--ember-surface-border)] bg-[color:var(--ember-surface)] px-3 text-sm font-semibold text-[color:var(--ember-text)] transition hover:bg-[color:var(--ember-surface-hover)] disabled:cursor-not-allowed disabled:opacity-60"
                        disabled={
                          canOneClickUpdate(selectedItem)
                            ? isPrimaryActionDisabled(
                                selectedItem,
                  ...
                  {selectedItem.installedState ? (
                    <section className="space-y-3">
                      <div className="flex items-center gap-2 text-sm font-semibold text-[color:var(--ember-text-strong)]">
                        <Layers3 size={16} />
                      ...
                      {selectedItem.entries.length > 0 ? (
                        <div className="grid gap-3 sm:grid-cols-2">
                          {selectedItem.entries.slice(0, 5).map((entry) => (
                            <button
                              key={entry.key}
                              type="button"
                              className="flex items-center justify-between gap-3 rounded-[10px] border border-[color:var(--ember-surface-border)] bg-[color:var(--ember-surface)] px-3 py-3 text-left transition hover:border-[color:var(--ember-surface-border-strong)] hover:bg-[color:var(--ember-surface-hover)] disabled:cursor-not-allowed disabled:opacity-60"
                              disabled={
                            ...
                            >
                              <span className="min-w-0">
                                <span className="block truncate text-sm font-medium text-[color:var(--ember-text-strong)]">
                                  {entry.title}
                                </span>
                                <span className="mt-1 block truncate text-xs text-[color:var(--ember-text-muted)]">
                                  {t(
                        ...
                        <p className="rounded-lg border border-dashed border-[color:var(--ember-surface-border)] bg-[color:var(--ember-surface-soft)] p-4 text-sm text-[color:var(--ember-text-muted)]">
                  ...
                  {selected ? (
                    <section
                      className="space-y-3 rounded-lg border border-[color:var(--ember-surface-border)] bg-[color:var(--ember-surface-soft)] p-3"
                      data-testid="agent-apps-lifecycle-actions"
                    >
                      <div className="grid gap-2 sm:grid-cols-2">
                        <button
                          type="button"
                          className="inline-flex items-center justify-center gap-2 rounded-full border border-amber-200 bg-[color:var(--ember-surface)] px-3 py-2 text-xs font-medium text-amber-700 transition hover:bg-amber-50 disabled:cursor-not-allowed disabled:opacity-60"
                        ...
                        <button
                          type="button"
                          className="inline-flex items-center justify-center gap-2 rounded-full border border-emerald-200 bg-[color:var(--ember-surface)] px-3 py-2 text-xs font-medium text-emerald-700 transition hover:bg-emerald-50 disabled:cursor-not-allowed disabled:opacity-60"
                          disabled={!selected.disabled || Boolean(busyAction)}
                          onClick={() =>
                        ...
                        <button
                          type="button"
                          className="rounded-full border border-[color:var(--ember-surface-border)] bg-[color:var(--ember-surface)] px-3 py-2 text-left text-xs font-medium text-[color:var(--ember-text)] transition hover:bg-[color:var(--ember-surface-hover)] disabled:cursor-not-allowed disabled:opacity-60"
                          disabled={Boolean(busyAction)}
                          onClick={() =>
                        ...
                        <button
                          type="button"
                          className="rounded-full border border-rose-200 bg-[color:var(--ember-surface)] px-3 py-2 text-left text-xs font-medium text-rose-800 transition hover:bg-rose-50 disabled:cursor-not-allowed disabled:opacity-60"
                          disabled={Boolean(busyAction)}
                          onClick={() =>
                      ...
                      {uninstallPreview ? (
                        <div
                          className="rounded-lg border border-[color:var(--ember-surface-border)] bg-[color:var(--ember-surface)] p-3"
                        ...
                        >
                          ...
                          {activeUninstallDescriptor?.mode === "delete-data" ? (
                            ...
                            >
                              ...
                              <div className="rounded-lg border border-rose-200 bg-[color:var(--ember-surface)] px-3 py-2">
                              ...
                              <input
                                ...
                                className="w-full rounded-full border border-rose-200 bg-[color:var(--ember-surface)] px-3 py-2 text-sm text-[color:var(--ember-text-strong)] outline-none transition placeholder:text-[color:var(--ember-text-muted)] focus:border-rose-400 focus:ring-2 focus:ring-rose-100"
                                placeholder={t(
                  ...
                  <section>
                    <button
                      type="button"
                      className="flex w-full items-center justify-between gap-3 rounded-[10px] border border-[color:var(--ember-surface-border)] bg-[color:var(--ember-surface)] px-3 py-3 text-left text-sm font-semibold text-[color:var(--ember-text-strong)] transition hover:bg-[color:var(--ember-surface-hover)]"
                      onClick={() => setMoreInfoOpen((open) => !open)}
                      data-testid="agent-apps-more-info"
                    >
                      {t("agentApp.apps.center.detail.moreInfo")}
                      <span className="text-xs font-medium text-[color:var(--ember-text-muted)]">
                        {moreInfoOpen
                    ...
                    {moreInfoOpen ? (
                      <div
                        className="mt-2 space-y-3 rounded-lg border border-[color:var(--ember-surface-border)] bg-[color:var(--ember-surface-soft)] p-3 text-xs text-[color:var(--ember-text-muted)]"
                      ...
                      >
                        ...
                        <div className="rounded-lg border border-[color:var(--ember-surface-border)] bg-[color:var(--ember-surface)] p-3">
                          <p className="text-sm font-semibold text-[color:var(--ember-text-strong)]">
                            {t("agentApp.apps.center.detail.sourceVersion")}
                          </p>
                          <div className="mt-3 grid gap-2 text-sm text-[color:var(--ember-text-muted)]">
                            <div className="flex items-center justify-between gap-3">
                              ...
                              <span className="font-medium text-[color:var(--ember-text-strong)]">
