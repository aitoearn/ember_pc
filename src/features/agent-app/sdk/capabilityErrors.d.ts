...
export declare const EMBER_CAPABILITY_ERROR_CODES: readonly ["capability_unavailable", "readiness_blocked", "permission_denied", "policy_denied", "schema_invalid", "source_unverified", "secret_required", "timeout", "cancelled", "conflict", "upstream_failed"];
export type LimeCapabilityErrorCode = (typeof EMBER_CAPABILITY_ERROR_CODES)[number];
