...
export declare const EMBER_AGENT_APP_BRIDGE_PROTOCOL = "ember.agentApp.bridge";
export declare const EMBER_AGENT_APP_BRIDGE_VERSION = 1;
...
export declare function applyEmberHostTheme(payload: unknown, options?: SyncEmberHostThemeOptions): EmberHostThemeSnapshot | null;
export declare function syncEmberHostTheme(invoker: Pick<LimeHostBridgeCapabilityInvoker, "onHostSnapshot" | "onThemeUpdate" | "getHostSnapshot">, options?: SyncEmberHostThemeOptions): () => void;
