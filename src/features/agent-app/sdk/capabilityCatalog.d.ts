...
export declare const EMBER_CAPABILITY_DEFINITIONS: readonly [{
    readonly name: "ember.ui";
    ...
    readonly summary: "Ember 桌面壳的提示、导航、下载、主题、快照和统一 Agent Run UI 能力。";
    ...
    readonly name: "ember.capabilities";
    readonly version: "0.3.0";
    readonly group: "governance";
    readonly stage: "preview";
    readonly owner: "desktop_host";
    ...
    readonly name: "ember.connectors";
    readonly version: "0.3.0";
    readonly group: "integration";
    readonly stage: "preview";
    ...
    readonly name: "ember.cloudSession";
    readonly version: "0.1.0";
    readonly group: "governance";
    readonly stage: "preview";
    readonly owner: "cloud_overlay";
    readonly methods: readonly ["getSnapshot", "getAccessToken", "requestLogin"];
    readonly summary: "宿主 Ember 当前云端会话快照、登录触发与 just-in-time 访问令牌能力，快照不暴露 bearer token。";
    ...
    readonly name: "ember.automation";
    readonly version: "0.3.0";
    readonly group: "agent_runtime";
    readonly stage: "preview";
    readonly owner: "agent_runtime";
...
export type LimeCapabilityDefinitionRecord = (typeof EMBER_CAPABILITY_DEFINITIONS)[number];
...
export type LimeCapabilityAdapterKey<Name extends LimeCapabilityName = LimeCapabilityName> = Name extends `ember.${infer Key}` ? Key : never;
export declare const EMBER_CAPABILITY_NAMES: readonly LimeCapabilityName[];
export declare const EMBER_CAPABILITY_GROUPS: readonly LimeCapabilityGroup[];
