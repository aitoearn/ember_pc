...
export { EMBER_CAPABILITY_NAMES } from "./capabilityCatalog";
...
export interface LimeCapabilityContractMap {
  "ember.ui": {
    ...
    closeAgentRun: {
      args: { taskId?: string; bridgeAction?: string } | undefined;
      value: {
        closed: true;
        surface: "host_agent_run";
        taskId?: string;
  ...
  "ember.files": {
    ...
    parse: {
      args: { ref: string; parser?: string; outputSchema?: unknown };
      value: unknown;
    };
  };
  "ember.agent": {
  ...
  "ember.knowledge": {
    ...
    bind: { args: { key: string; mode?: string }; value: unknown };
    export: { args: { key: string; format?: string }; value: unknown };
  };
  "ember.tools": {
  ...
  "ember.artifacts": {
    ...
    list: {
      args: { kind?: string; limit?: number } | undefined;
      value: AgentAppArtifactRecord[];
    };
  };
  "ember.workflow": {
  ...
  "ember.events": {
    emit: { args: { topic: string; payload?: unknown }; value: unknown };
    subscribe: { args: { topic: string }; value: unknown };
    unsubscribe: { args: { subscriptionId: string }; value: unknown };
    listSubscriptions: { args: undefined; value: unknown };
  };
  "ember.capabilities": {
    list: { args: undefined; value: unknown };
    get: { args: { capability: string }; value: unknown };
    getProfile: { args: undefined; value: unknown };
  };
  "ember.models": {
    list: { args: { taskKind?: string } | undefined; value: unknown };
    select: {
      args: { taskKind: string; constraints?: unknown };
      value: unknown;
    };
    getRouting: { args: { taskKind?: string } | undefined; value: unknown };
    estimateCost: {
      args: { taskKind: string; input?: unknown };
      value: unknown;
    };
  };
  "ember.usage": {
    getTokenUsage: {
      args: { taskId?: string; window?: string } | undefined;
      value: unknown;
    };
    getCostSummary: {
      args: { taskId?: string; window?: string } | undefined;
    ...
    getBudget: { args: { scope?: string } | undefined; value: unknown };
  };
  "ember.memory": {
    query: { args: { query: string; scope?: string }; value: unknown };
    write: { args: { scope: string; value: unknown }; value: unknown };
    compact: {
      args: { scope?: string; reason?: string } | undefined;
      value: unknown;
    };
    getStatus: { args: { scope?: string } | undefined; value: unknown };
  };
  "ember.skills": {
    list: { args: { kind?: string } | undefined; value: unknown };
    resolve: { args: { skillId: string }; value: unknown };
    bind: { args: { skillId: string; reason?: string }; value: unknown };
    invoke: { args: { skillId: string; input?: unknown }; value: unknown };
    getInvocation: { args: { invocationId: string }; value: unknown };
  };
  "ember.mcp": {
    listServers: { args: undefined; value: unknown };
    listTools: { args: { serverId?: string } | undefined; value: unknown };
    invoke: { args: { tool: string; input?: unknown }; value: unknown };
  };
  "ember.browser": {
    open: { args: { url?: string; profile?: string }; value: unknown };
    navigate: { args: { sessionId: string; url: string }; value: unknown };
    extract: { args: { sessionId: string; selector?: string }; value: unknown };
    screenshot: {
      args: { sessionId: string; fullPage?: boolean };
      value: unknown;
    };
    close: { args: { sessionId: string }; value: unknown };
  };
  "ember.search": {
    query: { args: { query: string; limit?: number }; value: unknown };
    deepResearch: { args: { query: string; depth?: number }; value: unknown };
    getRun: { args: { runId: string }; value: unknown };
  };
  "ember.documents": {
    parse: { args: { ref: string; outputSchema?: unknown }; value: unknown };
    export: { args: { artifactId: string; format: string }; value: unknown };
    transform: {
      args: { ref: string; operation: string; options?: unknown };
      value: unknown;
    };
    summarize: { args: { ref: string; instruction?: string }; value: unknown };
  };
  "ember.media": {
    generateImage: {
      args: { prompt: string; options?: unknown };
      value: unknown;
    };
    editImage: {
      args: { ref: string; prompt: string; options?: unknown };
      value: unknown;
    };
    transcribe: { args: { ref: string; options?: unknown }; value: unknown };
    synthesizeVoice: {
      args: { text: string; voice?: string; options?: unknown };
      value: unknown;
    };
  };
  "ember.terminal": {
    run: {
      args: { command: string; cwdRef?: string; reason?: string };
      value: unknown;
    };
    getRun: { args: { runId: string }; value: unknown };
    cancel: { args: { runId: string }; value: unknown };
  };
  "ember.tasks": {
    list: {
      args: { status?: string; limit?: number } | undefined;
      value: unknown;
    };
    get: { args: { taskId: string }; value: unknown };
    cancel: { args: { taskId: string }; value: unknown };
    subscribe: { args: { taskId: string }; value: unknown };
  };
  "ember.settings": {
    get: { args: { key: string }; value: unknown };
    set: {
      args: { key: string; value: unknown; reason?: string };
      value: unknown;
    };
    list: { args: { namespace?: string } | undefined; value: unknown };
  };
  "ember.workspace": {
    getCurrent: { args: undefined; value: unknown };
    list: { args: undefined; value: unknown };
    open: { args: { workspaceId: string }; value: unknown };
    getPathRef: { args: { purpose: string; path?: string }; value: unknown };
  };
  "ember.context": {
    getSnapshot: { args: { scope?: string } | undefined; value: unknown };
    attach: { args: { ref: string; kind?: string }; value: unknown };
    detach: { args: { ref: string }; value: unknown };
  };
  "ember.connectors": {
    list: { args: { kind?: string } | undefined; value: unknown };
    requestAuth: {
      args: { connectorId: string; reason?: string };
      value: unknown;
    };
    getStatus: { args: { connectorId: string }; value: unknown };
    invoke: {
      args: { connectorId: string; action: string; input?: unknown };
      value: unknown;
    };
  };
  "ember.automation": {
    startJob: { args: { jobKind: string; input?: unknown }; value: unknown };
    getJob: { args: { jobId: string }; value: unknown };
    cancelJob: { args: { jobId: string }; value: unknown };
  };
  "ember.review": {
    requestDecision: {
      args: { subject: string; payload?: unknown };
      value: unknown;
    };
    submitDecision: {
      args: { decisionId: string; decision: string; note?: string };
      value: unknown;
    };
    listPending: { args: { subject?: string } | undefined; value: unknown };
  };
}
