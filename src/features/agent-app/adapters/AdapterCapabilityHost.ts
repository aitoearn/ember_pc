...
export class AdapterCapabilityHost implements CapabilityHost {
  ...
  private createAgentCapability(
    ...
    this.assertCapabilityEnabled("ember.agent", provenance.entryKey, "adapter");
