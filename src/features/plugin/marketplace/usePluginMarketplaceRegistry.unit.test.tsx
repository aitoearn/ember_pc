...
function researchSnapshot(generatedAt = "2026-06-25T00:00:00.000Z") {
  return snapshot(generatedAt, [
    {
      item: marketplaceItem("research-kit@embercloud", {
        displayName: "Research Kit",
        category: "research",
      }),
      registry: registryItem("research-kit@embercloud", {
        displayName: "Research Kit",
      }),
    },
  ]);
  ...
  it("view options 更新时应复用现有 snapshot 重建模型，不应重复加载", async () => {
    const loader = vi.fn(async () =>
      snapshot("2026-06-25T00:00:00.000Z", [
        ...
        {
          item: marketplaceItem("notes-kit@embercloud", {
            displayName: "Notes Kit",
            category: "writing",
          }),
          registry: registryItem("notes-kit@embercloud", {
            displayName: "Notes Kit",
          }),
        },
      ]),
