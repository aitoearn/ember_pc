...
export type PluginCloudReleaseSignatureAlgorithm =
...
export type PluginPackageVerificationStatus =
  | "verified"
  | "missing"
...
export type PluginSetupBindingKind =
  | "knowledge"
  | "skill"
  | "tool"
  | "artifact"
...
export type PluginRuntimeProcessTimelineKind =
  | "progress"
  | "thinking"
  | "output"
  | "execution"
...
export type PluginSandboxPolicy =
  | "read-only"
  | "workspace-write"
  | "danger-full-access";
...
export type PluginTaskHostResponseActionType =
  | "tool_confirmation"
  | "ask_user"
  | "elicitation";
