...
const RUNTIME_AGENTS_GUIDE_STORAGE_KEY =
  "ember.runtime_agents_workspace_guide_seen.v1";
...
function buildRuntimeAgentsGuideCopy(): RuntimeAgentsGuideCopy {
  const currentI18n = i18n.isInitialized ? i18n : initEmberI18n();
  ...
  return {
    ...
    guideDescription: t("workspace.runtimeAgentsGuide.description", {
      defaultValue:
        "建议初始化共享规则 `.ember/AGENTS.md` 与本机私有规则 `.ember/AGENTS.local.md`，后者会自动加入 `.gitignore`。",
    }),
