...
interface OpenAICompatibleImageRequest {
...
interface NewApiResponsesImageRequest {
  model: string;
...
async function requestImageFromNewApiResponsesStream(
  apiHost: string,
  apiKey: string,
  model: string,
  prompt: string,
...
function buildNewApiResponsesImageRequest(
  model: string,
...
function extractImageBase64FromResponsesStreamEvent(
  rawEvent: string,
): string | null {
...
function normalizeOpenAICompatibleImageReferences(
  referenceImages: string[],
): string[] {
...
function buildOpenAICompatibleImageRequest(
  model: string,
  prompt: string,
  referenceImages: string[],
  size: string,
