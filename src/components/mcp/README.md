...
- 后端: `packages/app-server-client/src/protocol.ts`、`ember-rs/crates/app-server-protocol/src/protocol/v0.rs`、`ember-rs/crates/app-server/src/runtime.rs`、`ember-rs/crates/mcp/`
- 旧 Tauri wrapper: `ember-rs/src/commands/mcp_cmd.rs` 已删除；MCP 后续能力只允许继续进入 App Server current 或 Electron Desktop Host 壳边界
