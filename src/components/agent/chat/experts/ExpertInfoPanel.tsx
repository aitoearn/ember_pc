...
const Panel = styled.aside`
  ...
  box-shadow: 0 24px 56px -42px var(--ember-shadow-color, rgba(15, 23, 42, 0.18));
...
const PanelTitle = styled.div`
  ...
  align-items: center;
  gap: 8px;
  color: var(--ember-text-strong, #123d2e);
  font-size: 14px;
  font-weight: 760;
`;
...
const Avatar = styled.div`
  ...
  box-shadow: inset 0 0 0 1px
    var(--ember-surface-border, rgba(226, 240, 226, 0.9));
  overflow: hidden;
...
const IconActionButton = styled.button`
  ...
  align-items: center;
  justify-content: center;
  border: 1px solid var(--ember-brand, #10b981);
  border-radius: 10px;
  background: var(--ember-brand-soft, #ecfdf5);
  color: var(--ember-brand-strong, #166534);
  cursor: pointer;
  ...
  &:hover {
    border-color: var(--ember-brand-strong, #166534);
    background: var(--ember-surface, #ffffff);
    transform: translateY(-1px);
  }

  &:focus-visible {
    outline: 2px solid var(--ember-focus-ring, rgba(16, 185, 129, 0.28));
    outline-offset: 2px;
  }
`;

const Card = styled.div`
  border: 1px solid var(--ember-surface-border, rgba(226, 240, 226, 0.88));
  border-radius: 16px;
...
const Chip = styled.span`
  ...
  gap: 6px;
  border-radius: 10px;
  background: var(--ember-surface-muted, #f2f7f3);
  color: var(--ember-text, #1a3b2b);
  font-size: 12px;
  line-height: 1;
  padding: 7px 9px;
...
const WorkflowStep = styled.li`
  ...
  &::before {
    ...
    border-radius: 999px;
    background: var(--ember-surface, #ffffff);
    box-shadow: 0 0 0 3px var(--ember-brand-soft, #ecfdf5);
  }
  ...
  &:not(:last-child)::after {
    ...
    height: 22px;
    margin: 2px auto;
    background: var(--ember-surface-border-strong, #c7e7d1);
  }
`;
...
const SkillDialog = styled.div`
  ...
  border-radius: 24px;
  background: var(--ember-surface, #ffffff);
  box-shadow: 0 32px 90px -46px var(--ember-shadow-color, rgba(15, 23, 42, 0.32));
`;
...
const SkillDialogHeader = styled.div`
  ...
  gap: 12px;
  align-items: start;
  border-bottom: 1px solid var(--ember-surface-border, rgba(226, 240, 226, 0.88));
...
const DialogCloseButton = styled(IconActionButton)`
  border-color: var(--ember-surface-border, rgba(226, 240, 226, 0.92));
  background: var(--ember-surface-soft, #f8fcf9);
  color: var(--ember-text-muted, #6b826b);
`;
...
const CandidateAddButton = styled.button<{ $added?: boolean }>`
  ...
  background: ${({ $added }) =>
    $added
      ? "var(--ember-surface-muted, #f2f7f3)"
