...
const EMBER_CREATE_TASK_ACTIONS = {
  failed: "发起失败",
  completed: "已发起",
  running: "发起中",
} as const;
const EMBER_CREATE_TASK_ACTION_KEYS = {
...
const EXACT_TOOL_CONFIGS = new Map<string, ToolDisplayConfig>([
  ...
  [
    "embercreatevideogenerationtask",
    {
      ...
      groupTitleKey: "groupTitle",
      actionKey: "task",
      actions: EMBER_CREATE_TASK_ACTIONS,
      actionKeys: EMBER_CREATE_TASK_ACTION_KEYS,
    },
  ],
  [
...
export const resolveToolPrimarySubject = (
  ...
  if (
    ...
    normalizedName.startsWith("embercreate") ||
  ...
  if (normalizedName === "embersiterun" || normalizedName === "embersiteinfo") {
    return (
      resolveToolArgumentPreview(args, [
        "skill_title",
        "skillTitle",
