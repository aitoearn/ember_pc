...
import { projectCodingWorkbenchViewFromEvents } from "@embercloud/agent-runtime-projection";
...
vi.mock("@embercloud/agent-runtime-projection", async (importOriginal) => {
  const actual =
    await importOriginal<typeof import("@embercloud/agent-runtime-projection")>();
  return {
    ...actual,
