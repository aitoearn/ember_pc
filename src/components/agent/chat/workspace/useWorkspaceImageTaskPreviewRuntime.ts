...
const IMAGE_TASK_EVENT_NAME = "ember://creation_task_submitted";
...
function resolveImageRuntimeContractSnapshot(params: {
  ...
  const embercorePolicySnapshot =
    asRecord(runtimeContract?.embercore_policy_snapshot) ||
    asRecord(runtimeContract?.embercorePolicySnapshot) ||
    asRecord(payload?.embercore_policy_snapshot) ||
    asRecord(payload?.embercorePolicySnapshot);
  const embercorePolicyEvaluation =
    asRecord(embercorePolicySnapshot?.policy_evaluation) ||
    asRecord(embercorePolicySnapshot?.policyEvaluation);
  ...
  return {
    ...
    embercorePolicySnapshotStatus:
      readString([embercorePolicySnapshot], ["status"]) || null,
    embercorePolicyDecision:
      readString([embercorePolicySnapshot], ["decision"]) || null,
    embercorePolicyDecisionSource:
      readString(
        [embercorePolicySnapshot],
        ["decision_source", "decisionSource"],
      ) || null,
    embercorePolicyDecisionScope:
      readString(
        [embercorePolicySnapshot],
        ["decision_scope", "decisionScope"],
      ) || null,
    embercorePolicyDecisionReason:
      readString(
        [embercorePolicySnapshot],
        ["decision_reason", "decisionReason"],
      ) || null,
    embercorePolicyMissingInputs: readStringArray(
      [embercorePolicySnapshot],
      ["missing_inputs", "missingInputs"],
    ),
    embercorePolicyPendingHitRefs: readStringArray(
      [embercorePolicySnapshot],
      ["pending_hit_refs", "pendingHitRefs"],
    ),
    embercorePolicyEvaluationStatus:
      readString([embercorePolicyEvaluation], ["status"]) || null,
    embercorePolicyEvaluationDecision:
      readString([embercorePolicyEvaluation], ["decision"]) || null,
    embercorePolicyEvaluationDecisionSource:
      readString(
        [embercorePolicyEvaluation],
        ["decision_source", "decisionSource"],
      ) || null,
    embercorePolicyEvaluationDecisionScope:
      readString(
        [embercorePolicyEvaluation],
        ["decision_scope", "decisionScope"],
      ) || null,
    embercorePolicyEvaluationDecisionReason:
      readString(
        [embercorePolicyEvaluation],
        ["decision_reason", "decisionReason"],
      ) || null,
    embercorePolicyEvaluationBlockingRefs: readStringArray(
      [embercorePolicyEvaluation],
      ["blocking_refs", "blockingRefs"],
    ),
    embercorePolicyEvaluationAskRefs: readStringArray(
      [embercorePolicyEvaluation],
      ["ask_refs", "askRefs"],
    ),
    embercorePolicyEvaluationPendingRefs: readStringArray(
      [embercorePolicyEvaluation],
