...
describe("workspacePath", () => {
  it("应将 macOS 下的 .proxycast 项目目录规范到 ember app data", () => {
    expect(
      normalizeManagedWorkspacePathForDisplay(
        "/Users/coso/.proxycast/projects/default/exports/demo",
      ),
    ).toBe(
      "/Users/coso/Library/Application Support/ember/projects/default/exports/demo",
    );
  });

  it("应将 macOS 下的旧 app data 项目目录规范到 ember app data", () => {
    expect(
      normalizeManagedWorkspacePathForDisplay(
