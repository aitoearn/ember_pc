...
继续验证
      ...
      checkpoints: [
        {
          ...
          snapshot_path: ".ember/file-checkpoints/checkpoint-greeting.ts",
  ...
  it("文件变更审查卡应隐藏绝对路径前缀并向工作台传入完整 diff", () => {
      ...
      contentParts: [
        {
          ...
          aggregate: {
            ...
            files: [
              {
                path: "/Users/coso/Library/Application Support/ember/projects/Demo/.ember/qc/code-runtime-fixture/src/greeting.ts",
                kind: "update",
                linesAdded: 1,
                linesRemoved: 1,
                truncated: false,
    ...
    expect(container.textContent).not.toContain(
      "/Users/coso/Library/Application Support/ember/projects/Demo",
    );
    ...
    expect(onFileClick.mock.calls[0]?.[0]).toBe(
      "/Users/coso/Library/Application Support/ember/projects/Demo/.ember/qc/code-runtime-fixture/src/greeting.ts",
    );
  ...
  it("内容工作台工具过程组应保持正文前后顺序并隐藏协议细节", () => {
        ...
        },
        {
          ...
          toolCall: {
            ...
            result: {
              success: true,
              output: JSON.stringify({
                artifact_path: ".ember/tasks/video_generate/demo.json",
              }),
            },
        ...
        },
        {
          ...
          toolCall: {
            ...
            result: {
              success: true,
              output: JSON.stringify({
                artifact_path: ".ember/tasks/audio_generate/demo.json",
              }),
            },
    ...
    expect(text).not.toContain(".ember/tasks");
    expect(text).not.toContain("artifact_path");
    expect(text).not.toContain("ember_create_video_generation_task");
  });
