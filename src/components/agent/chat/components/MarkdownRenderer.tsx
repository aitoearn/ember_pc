...
const MarkdownContainer = styled.div`
  ...
  th,
  td {
    border-right: 1px solid var(--ember-surface-border, hsl(var(--border)));
  ...
  tbody tr:nth-child(even) td {
    background: var(--ember-surface-soft, hsl(var(--secondary) / 0.5));
  }
...
const MarkdownQuoteCard = styled.blockquote`
  margin: 0 0 0.95em;
  padding: 0;
  border: 1px solid var(--ember-surface-border-strong, hsl(var(--border)));
  border-radius: 20px;
  background: linear-gradient(
    180deg,
    var(--ember-surface, hsl(var(--background))) 0%,
    var(--ember-surface-soft, hsl(var(--secondary) / 0.5)) 100%
  );
...
const MarkdownTableScroll = styled.div`
  ...
  border: 1px solid var(--ember-surface-border-strong, hsl(var(--border)));
  border-radius: 8px;
  background: var(--ember-surface, hsl(var(--background)));
