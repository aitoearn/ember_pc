...
describe("MarkdownRenderer", () => {
  ...
  it("应通过同目录 meta.json 将远程图片替换为本地下载资源", async () => {
    vi.mocked(fileBrowserModule.readFilePreview).mockResolvedValue({
      path: "/Users/coso/.ember/projects/default/exports/x-article/google/meta.json",
    ...
    expect(image).not.toBeNull();
    expect(mockConvertLocalFileSrc).toHaveBeenCalledWith(
      "/Users/coso/.ember/projects/default/exports/x-article/google/images/hero.png",
    );
    expect(image?.getAttribute("src")).toBe(
      "asset:///Users/coso/.ember/projects/default/exports/x-article/google/images/hero.png",
    );
  });
