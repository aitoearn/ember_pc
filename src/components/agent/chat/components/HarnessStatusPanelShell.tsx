...
export function HarnessStatusPanelShell({
  ...
  return (
    <div
      ...
      data-layout={layout}
      className={cn(
        "ember-workbench-theme-scope ember-workbench-surface-scope text-[color:var(--ember-text)]",
        layout === "sidebar"
          ? "rounded-xl border border-[color:var(--ember-surface-border)] bg-[color:var(--ember-surface)]"
          : layout === "dialog"
            ? "flex h-full min-h-0 flex-col overflow-hidden rounded-xl border border-[color:var(--ember-surface-border)] bg-[color:var(--ember-surface)]"
            : "mx-3 mt-2 rounded-2xl border border-[color:var(--ember-surface-border)] bg-[color:var(--ember-surface-soft)]",
      )}
    >
      <HarnessPanelHeader
