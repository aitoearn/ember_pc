...
function createAggregate(): FileChangesAggregate {
  return {
    ...
    files: [
      {
        path: "/workspace/projects/Demo/.ember/qc/code-runtime-fixture/src/greeting.ts",
        kind: "update",
        linesAdded: 2,
        linesRemoved: 1,
        truncated: false,
        ...
        diff: [
          ...
          {
            kind: "add",
            value: "  return 'Hello Ember Runtime';",
          },
          {
            kind: "add",
...
describe("FileChangesSummaryCard", () => {
  it("应使用真实 i18n 生成工作台变更审阅内容，且左卡隐藏绝对路径前缀", () => {
    ...
    expect(calls[0]?.[1]).toContain("+  return 'Hello Ember Runtime';");
