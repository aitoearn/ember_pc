...
describe("agentChatHistory", () => {
  it("追加累计 text_delta 时不应重复吐字", () => {
    expect(
      appendTextToParts([{ type: "text", text: "你好" }], "你好！我是 Ember"),
    ).toEqual([{ type: "text", text: "你好！我是 Ember" }]);
  });
  ...
  it("历史 output_text 以累计快照存储时应恢复为单份正文", () => {
      ...
      messages: [
        {
          ...
          content: [
            ...
            { type: "output_text", text: "你好！我是 Ember 助手。" } as never,
          ],
        },
      ],
    };
    ...
    expect(messages[0]?.content).toBe("你好！我是 Ember 助手。");
        ...
        artifacts: [
          {
            ...
            path: ".ember/qc/code-artifact-workbench/src/greeting.ts",
            title: "greeting.ts",
            kind: "code",
            status: "complete",
      ...
      artifacts: [
        {
          ...
          meta: {
            filePath: ".ember/qc/code-artifact-workbench/src/greeting.ts",
            artifactPath: ".ember/qc/code-artifact-workbench/src/greeting.ts",
            previewText: "export const greeting = 'hello';",
          },
        },
      ],
      ...
      messages: [
        {
          ...
          content: [
            ...
            } as never,
            {
              ...
              tool_name: "ember_create_image_generation_task",
              arguments: {
  ...
  it("压缩水合时应从历史纯 JSON 图片工具输出恢复轻卡并清理提交摘要", () => {
    const imageTaskOutput = JSON.stringify({
      ...
      path: ".ember/tasks/image_generate/task-history-json-image-1.json",
      absolute_path:
        "/workspace/.ember/tasks/image_generate/task-history-json-image-1.json",
      artifact_path:
        ".ember/tasks/image_generate/task-history-json-image-1.json",
      progress: {
          ...
          content: [
            {
              ...
              text: [
                ...
                "任务文件：.ember/tasks/image_generate/task-history-json-image-1.json",
                "状态：pending_submit",
              ].join("\n"),
            } as never,
          ],
    ...
    expect(assistant?.imageWorkbenchPreview).toMatchObject({
      ...
      taskFilePath:
        "/workspace/.ember/tasks/image_generate/task-history-json-image-1.json",
      artifactPath: ".ember/tasks/image_generate/task-history-json-image-1.json",
    });
  });
      ...
      messages: [
        {
          ...
          content: [
            { type: "text", text: "正在生成广州塔夜景海报" } as never,
            {
              ...
              arguments: {
                command:
                  'ember media image generate --prompt "广州塔夜景海报" --size 1536x1024 --count 1',
              },
            } as never,
          ],
        },
      ...
      messages: [
        {
          ...
          content: [
            { type: "text", text: "正在生成广州塔城市短片" } as never,
            {
              ...
              arguments: {
                command:
                  'ember media video generate --prompt "广州塔城市短片" --duration 15 --aspect-ratio 16:9 --resolution 720p',
              },
            } as never,
          ],
        },
  ...
  it("刷新会话详情时不应把已完成输出替换成后端历史投影", () => {
    const localMessages = [
      ...
      },
      {
        ...
        role: "assistant" as const,
        content: "这张截图展示了 Ember 聊天区把图片恢复成了可见缩略图。",
        contentParts: [
          {
            type: "text" as const,
            text: "这张截图展示了 Ember 聊天区把图片恢复成了可见缩略图。",
          },
        ],
        timestamp: new Date("2026-05-12T10:00:02.000Z"),
      },
    ...
    const localMessages = [
      {
        ...
        role: "user" as const,
        content:
          "/brand-product-knowledge-builder 请根据现有资料整理 Ember 产品知识库并保留边界说明",
    ...
    const hydratedMessages = [
      {
        ...
        role: "user" as const,
        content: "请根据现有资料整理 Ember 产品知识库并保留边界说明",
