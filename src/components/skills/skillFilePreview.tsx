        ...
        return (
          <button
            ...
            className={cn(
              ...
              isSelected
                ...
                : "text-[color:var(--ember-text)] hover:bg-[color:var(--ember-surface)]",
            )}
          ...
          >
            ...
            {!entry.isDirectory && entry.size > 0 ? (
              <span className="shrink-0 text-[10px] text-[color:var(--ember-text-muted)]">
...
export function SkillFileContentPreview({
  ...
  if (content) {
    return isSkillMarkdownFile(selectedFile) ? (
      ...
      <pre className="overflow-auto rounded-lg border border-[color:var(--ember-surface-border)] bg-[color:var(--ember-surface-soft)] p-4 text-sm leading-6 text-[color:var(--ember-text-strong)]">
        {content}
      </pre>
    );
  }
