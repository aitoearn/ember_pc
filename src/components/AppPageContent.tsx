...
const loadDeviceAutomationWorkspace = () =>
...
export function AppPageContent({
  ...
  if (activePage === "device-automation") {
    return (
      <PageWrapper
        $isActive={true}
      ...
      >
        <DeviceAutomationWorkspace
          pageParams={activePageParams as DeviceAutomationPageParams}
          onNavigate={onNavigate}
        />
      </PageWrapper>
    );
  ...
  if (activePage === "agent-observability") {
    return (
      <PageWrapper
        $isActive={true}
        className="ember-workbench-theme-scope"
      ...
      >
        <AgentObservabilityWorkspace
          pageParams={activePageParams as AgentObservabilityPageParams}
          onNavigate={onNavigate}
        />
      </PageWrapper>
    );
