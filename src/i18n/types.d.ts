...
import deviceAutomation from "./resources/zh-CN/deviceAutomation.json";
import agentObservability from "./resources/zh-CN/agentObservability.json";
import testCaseManagement from "./resources/zh-CN/testCaseManagement.json";
...
declare module "i18next" {
  interface CustomTypeOptions {
    ...
    resources: {
      ...
      deviceAutomation: typeof deviceAutomation;
      agentObservability: typeof agentObservability;
      testCaseManagement: typeof testCaseManagement;
