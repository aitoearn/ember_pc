...
function usage(): string {
  return [
    ...
    "",
    "复用 Ember 本地配图网关验收：",
    "  npm exec -- tsx scripts/verify-layered-design-gpt-image-live.ts --ember-local-image-gateway --provider-id <provider-id> --allow-external-image-generation --output internal/roadmap/ai-layered-design/evidence/gpt-image-live.json --image-output internal/roadmap/ai-layered-design/evidence/gpt-image-live.png",
    "  npm exec -- tsx scripts/verify-layered-design-gpt-image-live.ts --ember-local-image-gateway --auto-provider --allow-external-image-generation --output internal/roadmap/ai-layered-design/evidence/gpt-image-live.json --image-output internal/roadmap/ai-layered-design/evidence/gpt-image-live.png",
    "",
    "可选参数：",
