...
const I18N_CHROME_EXTENSION_WORKFLOW_FILES = new Set([
  ...
  "extensions/ember-chrome/CHROME_WEB_STORE_SUBMISSION.md",
  "extensions/ember-chrome/README.md",
  "extensions/ember-chrome/manifest.json",
  "extensions/ember-chrome/pages/scripts/install-i18n.js",
  "extensions/ember-chrome/pages/scripts/options.js",
...
function isDocsChange(file) {
  return (
    ...
    file.startsWith("docs/tests/") ||
    file.startsWith("docs/test/agent-qc-") ||
    file.startsWith("docs/roadmap/i18n/") ||
    isMarkdownLike(file)
  );
}
...
function isRustChange(file) {
  return file.startsWith("ember-rs/");
}
