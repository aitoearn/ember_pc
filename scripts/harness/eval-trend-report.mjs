...
function getBreakdownEntries(summary, key) {
  return Array.isArray(summary?.breakdowns?.[key])
...
function renderText(report) {
  ...
  if (topVerificationOutcomeDeltas.length > 0) {
    lines.push(
      "[harness-eval-trend] observability verification outcome deltas:",
    );
  ...
  if (topCurrentRecoveredVerificationDeltas.length > 0) {
    lines.push(
      "[harness-eval-trend] current recovered verification baseline deltas:",
    );
...
function renderMarkdown(report) {
  ...
  if (report.classificationDeltas.reviewDecisionStatuses.length > 0) {
    ...
    lines.push("");
    lines.push(
      "| 审核状态 | baseline case | latest case | delta case | delta invalid |",
    );
    lines.push("| --- | --- | --- | --- | --- |");
  ...
  if (report.classificationDeltas.reviewRiskLevels.length > 0) {
    ...
    lines.push("");
    lines.push(
      "| 风险等级 | baseline case | latest case | delta case | delta invalid |",
    );
    lines.push("| --- | --- | --- | --- | --- |");
  ...
  if (report.classificationDeltas.observabilitySignals.length > 0) {
    ...
    lines.push("");
    lines.push(
      "| Signal | baseline case | latest case | delta case | delta invalid |",
    );
    lines.push("| --- | --- | --- | --- | --- |");
  ...
  if (
    report.classificationDeltas.observabilityVerificationOutcomes.length > 0
  ) {
    lines.push("");
    lines.push("## Observability Verification Outcome 变化");
    lines.push("");
    lines.push(
      "| Outcome | baseline case | latest case | delta case | delta invalid |",
    );
    lines.push("| --- | --- | --- | --- | --- |");
    for (const entry of report.classificationDeltas
      .observabilityVerificationOutcomes) {
      lines.push(
        `| ${entry.name} | ${entry.baseline.caseCount} | ${entry.latest.caseCount} | ${entry.delta.caseCount} | ${entry.delta.invalidCount} |`,
      );
  ...
  if (
    report.classificationDeltas
      .currentRecoveredObservabilityVerificationOutcomes.length > 0
  ) {
    lines.push("");
