...
function collectProductionMockOnlyUsageFailures() {
  ...
  for (const relativePath of collectRustSourceFiles(
    "ember-rs/src/dev_bridge/dispatcher",
  )) {
...
function collectRetiredAutomationFacadeSourceFailures() {
  ...
  const restrictedSources = [
    ...
    {
      path: "ember-rs/src/commands/mod.rs",
      message:
        "已迁到 App Server automation* 的旧自动化命令不能回到 legacy Tauri command module",
    },
    {
      path: "ember-rs/src/dev_bridge/dispatcher.rs",
      message:
...
function collectRetiredApiKeyProviderFacadeSourceFailures() {
  ...
  const restrictedSources = [
    ...
    {
      path: "ember-rs/src/dev_bridge/dispatcher/providers.rs",
      message:
...
function collectRetiredMcpDesktopFacadeSourceFailures() {
  ...
  const restrictedSources = [
    ...
    {
      paths: collectRustSourceFiles("ember-rs/src/dev_bridge/dispatcher"),
      message:
        "已迁到 App Server MCP current API 的旧 MCP 命令不能回到 Rust DevBridge dispatcher",
    },
    {
...
function collectRetiredAgentAppPackageFacadeSourceFailures() {
  ...
  const restrictedSources = [
    ...
    {
      path: "ember-rs/src/dev_bridge/dispatcher/agent_apps.rs",
      message:
...
function collectRetiredLogFacadeSourceFailures() {
  ...
  const restrictedSources = [
    ...
    {
      path: "ember-rs/src/dev_bridge/dispatcher/app_runtime.rs",
      message:
        "已迁到 App Server diagnostics/* 的旧诊断命令不能回到 Rust DevBridge app runtime dispatcher",
    },
    {
      path: "ember-rs/src/dev_bridge/dispatcher/logs.rs",
      message:
  ...
  const deletedWrapperSources = [
    "ember-rs/src/app/commands/logs.rs",
    "ember-rs/src/app/commands/server.rs",
    "ember-rs/src/commands/windows_startup_cmd.rs",
  ];
  ...
  const appCommandsModPath = "ember-rs/src/app/commands/mod.rs";
...
function collectRetiredConfigFacadeSourceFailures() {
  ...
  const restrictedSources = [
    ...
    {
      path: "ember-rs/src/app/commands/config.rs",
      message:
  ...
  for (const source of restrictedSources) {
    ...
    for (const command of retiredConfigTauriGenerateHandlerCommands) {
      const hasRetiredConfigFacade =
        source.path === "ember-rs/src/app/runner.rs"
...
function collectRetiredChannelSideEffectFacadeSourceFailures() {
    ...
    for (const relativePath of paths) {
      ...
      for (const command of retiredChannelSideEffectFacadeCommands) {
        const hasRetiredChannelFacade =
          relativePath === "ember-rs/src/app/runner.rs"
            ? hasTauriCommandRegistration(sourceCode, command)
  ...
  const deletedDispatcherPath =
    "ember-rs/src/dev_bridge/dispatcher/runtime_queries.rs";
  ...
  const commandsModPath = "ember-rs/src/commands/mod.rs";
  ...
  for (const retiredWrapperPath of [
    "ember-rs/src/commands/gateway_channel_cmd.rs",
    "ember-rs/src/commands/wechat_channel_cmd.rs",
  ]) {
...
function collectRetiredGatewayTunnelFacadeSourceFailures() {
  ...
  const runnerPath = "ember-rs/src/app/runner.rs";
  const runnerSource = readProductionSourceForGuard(runnerPath);
  for (const token of ["GatewayTunnelState", "ember_gateway::tunnel::"]) {
...
function collectCurrentHotkeyDesktopHostShellSourceFailures() {
  ...
  const restrictedSources = [
    ...
    {
      path: "ember-rs/src/dev_bridge/dispatcher/voice.rs",
      message:
        "快捷键状态 / 校验是 Electron Desktop Host 快捷键壳能力，不能回到 Rust DevBridge dispatcher",
    },
    {
      path: "ember-rs/src/voice/commands.rs",
      message:
  ...
  for (const retiredPath of ["ember-rs/src/commands/hotkey_cmd.rs"]) {
...
function collectCurrentVoiceModelDesktopHostSourceFailures() {
  ...
  const voiceModelCommandPath = "ember-rs/src/commands/voice_model_cmd.rs";
...
function collectRetiredVoiceModelTestTranscribeFacadeSourceFailures() {
  ...
  const retiredWrapperPath = "ember-rs/src/commands/voice_model_cmd.rs";
  if (fs.existsSync(path.join(repoRoot, retiredWrapperPath))) {
    failures.push({
      file: retiredWrapperPath,
...
function collectRetiredVoiceInputConfigFacadeSourceFailures() {
  ...
  const restrictedSources = [
    ...
    {
      path: "ember-rs/src/commands/aster_agent_cmd/runtime_turn/bootstrap.rs",
      message:
  ...
  const voiceCommandPath = "ember-rs/src/voice/commands.rs";
...
function collectRetiredVoiceAsrCredentialFacadeSourceFailures() {
  ...
  const retiredWrapperPath = "ember-rs/src/commands/asr_cmd.rs";
  if (fs.existsSync(path.join(repoRoot, retiredWrapperPath))) {
    failures.push({
      file: retiredWrapperPath,
      message:
...
function collectRetiredVoiceRealtimeFacadeSourceFailures() {
  ...
  const retiredWrapperPath = "ember-rs/src/voice/commands.rs";
  if (fs.existsSync(path.join(repoRoot, retiredWrapperPath))) {
    failures.push({
      file: retiredWrapperPath,
      message:
...
function collectCurrentSkillDesktopHostShellSourceFailures() {
  const failures = [];
  const retiredSkillCommandPath = "ember-rs/src/commands/skill_cmd.rs";
  ...
  const restrictedSources = [
    ...
    {
      path: "ember-rs/src/dev_bridge/dispatcher/skills.rs",
      message:
...
function collectCurrentLayeredDesignDesktopHostShellSourceFailures() {
  ...
  const retiredLayeredDesignCommandPath =
    "ember-rs/src/commands/layered_design_cmd.rs";
...
function collectRetiredAgentRuntimeRustSourceFailures() {
  ...
  const restrictedSources = [
    ...
    {
      path: "ember-rs/src/dev_bridge/dispatcher/agent_sessions.rs",
      message:
    ...
    {
      path: "ember-rs/src/commands/agent_cmd.rs",
      message:
        "Agent process 旧 Tauri wrapper 已撤下，不能在 agent_cmd.rs 恢复可调用 Rust wrapper",
      commands: retiredAgentRuntimeProcessAsterRustCommands,
    },
    {
      path: "ember-rs/src/commands/aster_agent_cmd/action_runtime.rs",
      message:
    ...
    {
      path: "ember-rs/src/commands/aster_agent_cmd/command_api/session_api.rs",
      message:
        "Agent Runtime session CRUD 旧 Tauri wrapper 已撤下，不能在 commands/** 恢复可调用 Rust wrapper",
    },
    {
      path: "ember-rs/src/commands/aster_agent_cmd/command_api/subagent_api.rs",
      message:
    ...
    {
      path: "ember-rs/src/commands/aster_agent_cmd/command_api.rs",
      message:
    ...
    {
      path: "ember-rs/src/commands/aster_agent_cmd/mod.rs",
      message:
    ...
    {
      path: "ember-rs/src/commands/aster_agent_cmd/command_api/provider_api.rs",
      message:
        "Aster provider/status/reset 旧 Tauri wrapper 已撤下，不能在 commands/** 恢复可调用 Rust wrapper",
      commands: retiredAgentRuntimeProcessAsterRustCommands,
    },
    {
      path: "ember-rs/src/commands/aster_agent_cmd/command_api/objective_api.rs",
      message:
    ...
    {
      path: "ember-rs/src/commands/aster_agent_cmd/command_api/objective_audit.rs",
      message:
        "Agent Runtime objective audit 旧 Tauri wrapper 已撤下，不能在 commands/** 恢复可调用 Rust wrapper",
      commands: retiredAgentRuntimeCompactObjectiveRustCommands,
    },
    {
      path: "ember-rs/src/commands/aster_agent_cmd/command_api/runtime_api.rs",
      message:
...
function collectRetiredSkillExecutionFacadeSourceFailures() {
  ...
  const retiredWrapperPath = "ember-rs/src/commands/skill_exec_cmd.rs";
  if (fs.existsSync(path.join(repoRoot, retiredWrapperPath))) {
    failures.push({
      file: retiredWrapperPath,
...
function collectRetiredVideoGenerationPromptSourceFailures() {
  ...
  const restrictedSources = [
    {
      path: "ember-rs/src/commands/aster_agent_cmd/video_skill_launch.rs",
      message:
        "Video skill launch 必须走 video_generate -> App Server mediaTaskArtifact/video/* current 主链，不能提示模型回退旧 video generation facade",
    },
    {
      path: "ember-rs/resources/default-skills/video_generate/SKILL.md",
      message:
  ...
  const themeVideoModulePath = "ember-rs/src/theme/video/mod.rs";
...
function collectRetiredGalleryMaterialFacadeSourceFailures() {
  ...
  const restrictedSources = [
    ...
    {
      path: "ember-rs/src/dev_bridge/dispatcher/project_resources.rs",
      message:
  ...
  for (const retiredPath of ["ember-rs/src/commands/gallery_material_cmd.rs"]) {
    if (fs.existsSync(path.join(repoRoot, retiredPath))) {
      failures.push({
        file: retiredPath,
        message:
...
function collectRetiredProjectMaterialFacadeSourceFailures() {
  ...
  for (const retiredPath of ["ember-rs/src/commands/material_cmd.rs"]) {
    if (fs.existsSync(path.join(repoRoot, retiredPath))) {
      failures.push({
        file: retiredPath,
        message:
...
function collectRetiredExecutionRunFacadeSourceFailures() {
  ...
  const restrictedSources = [
    ...
    {
      path: "ember-rs/src/dev_bridge/dispatcher/runtime_queries.rs",
      message:
  ...
  const retiredWrapperPath = "ember-rs/src/commands/execution_run_cmd.rs";
  if (fs.existsSync(path.join(repoRoot, retiredWrapperPath))) {
    failures.push({
      file: retiredWrapperPath,
...
function collectRetiredFrontendSessionFileFacadeSourceFailures() {
  ...
  const retiredWrapperPath = "ember-rs/src/commands/session_files_cmd.rs";
  if (fs.existsSync(path.join(repoRoot, retiredWrapperPath))) {
    failures.push({
      file: retiredWrapperPath,
...
function collectRetiredTauriCommandModuleFailures() {
  ...
  for (const moduleName of retiredTauriCommandModules) {
    ...
    const modulePath = `ember-rs/src/commands/${moduleName}.rs`;
