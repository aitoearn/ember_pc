...
const KNOWLEDGE_MATCHERS = [
  ...
  prefix("scripts/knowledge/"),
  prefix("ember-rs/crates/knowledge/"),
  exact("ember-rs/src/commands/aster_agent_cmd/runtime_turn.rs"),
  exact("ember-rs/src/dev_bridge/dispatcher.rs"),
  exact("ember-rs/src/dev_bridge/dispatcher/files.rs"),
  exact("ember-rs/src/skills/default_skills.rs"),
  exact("ember-rs/crates/core/src/models/mod.rs"),
  exact("ember-rs/crates/core/src/models/skill_model.rs"),
  prefix("ember-rs/resources/default-skills/knowledge_builder/"),
  prefix("ember-rs/resources/default-skills/personal-ip-knowledge-builder/"),
  prefix("ember-rs/resources/default-skills/brand-persona-knowledge-builder/"),
  prefix("ember-rs/resources/default-skills/brand-product-knowledge-builder/"),
  prefix(
    "ember-rs/resources/default-skills/organization-knowhow-knowledge-builder/",
  ),
  prefix("ember-rs/resources/default-skills/growth-strategy-knowledge-builder/"),
  prefix(
  ...
  prefix("src/lib/desktop-host/core"),
...
const NON_KNOWLEDGE_MATCHERS = [
  ...
  exact("ember-rs/src/commands/layered_design_cmd.rs"),
...
function classify(entry) {
  const knowledge = entry.paths.some((filePath) =>
    matches(filePath, KNOWLEDGE_MATCHERS),
  );
  const nonKnowledge = entry.paths.some((filePath) =>
    matches(filePath, NON_KNOWLEDGE_MATCHERS),
  );
