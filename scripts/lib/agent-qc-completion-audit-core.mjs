...
function buildAgentQcCompletionAudit(facts) {
  ...
  const items = [
    createItem(
      ...
      "internal/tests/agent-ops-qc.md, internal/tests/agent-qc-p0-scenarios.md, internal/tests/ember-agent-qc-rollout-plan.md, internal/tests/README.md",
    ...
    createItem(
      ...
      "scripts/agent-qc/qcloop-status.mjs, internal/tests/ember-agent-qc-qcloop-operations.md",
    ...
    createItem(
      ...
      "scripts/agent-qc/gui-owner-check.mjs, internal/tests/ember-agent-qc-qcloop-operations.md",
