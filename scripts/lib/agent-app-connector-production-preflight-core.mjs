...
const CONNECTOR_RULES = {
  notion: [
    ...
    },
    {
      ...
      key: "EMBER_AGENT_APP_NOTION_WORKSPACE_ID",
  ...
  webhook: [
    {
      ...
      aliases: ["EMBER_AGENT_APP_CONNECTOR_WEBHOOK_URL_FILE"],
