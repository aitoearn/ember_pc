...
Remote webhook delivery can use EMBER_AGENT_APP_CONNECTOR_WEBHOOK_URL or
EMBER_AGENT_APP_CONNECTOR_WEBHOOK_URL_FILE; file content must be a non-local https URL.`);
}
