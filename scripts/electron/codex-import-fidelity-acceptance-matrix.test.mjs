...
const SOURCE_SCAN_TEST_PATH =
  "ember-rs/crates/app-server/src/runtime/conversation_import/tests.rs";
const SOURCE_HEALTH_TEST_PATH =
  "ember-rs/crates/app-server/src/runtime/conversation_import/tests/health.rs";
const PATH_RESOLUTION_TEST_PATH =
  "ember-rs/crates/app-server/src/runtime/conversation_import/tests/path_resolution.rs";
const SECURITY_TEST_PATH =
  "ember-rs/crates/app-server/src/runtime/conversation_import/tests/security.rs";
const EVIDENCE_TEST_PATH =
  "ember-rs/crates/app-server/src/runtime/conversation_import/tests/evidence.rs";
...
const CONVERSATION_IMPORT_PROTOCOL_PATH =
  "ember-rs/crates/app-server-protocol/src/protocol/v0/conversation_import.rs";
...
describe("codex import fidelity acceptance matrix guard", () => {
  it("documents the current fact source and excludes legacy implementation paths", () => {
    ...
    expect(matrix).toContain("旧 Tauri / `ember-rs/src/**` / 旧 `agent_runtime_*` 不作为新增能力落点");
