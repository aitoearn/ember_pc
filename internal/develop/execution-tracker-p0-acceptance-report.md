...
> 验收日期：2026-02-20  
> 对应规划：`internal/develop/execution-tracker-technical-plan.md`
...
- `ember-rs/src/commands/skill_exec_cmd.rs`
...
- `ember-rs/src/commands/execution_run_cmd.rs`
...
- `cd ember-rs && cargo check`
- `cd ember-rs && cargo test -p ember-core agent_run::tests -- --nocapture`
- `cd ember-rs && cargo test -p ember execution_tracker_service::tests -- --nocapture`
- `npm run build`
