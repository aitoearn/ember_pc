...
Ember 的未来方向是从 **API 代理工具** 演进为 **AI Agent 创作平台**。
核心目标是让用户能够：
...
```rust
// ember-rs/src/agent/definition.rs
...
```rust
// ember-rs/src/agent/tools/mod.rs
...
```rust
// ember-rs/src/agent/messages.rs
...
```rust
// ember-rs/src/agent/streaming.rs
...
```rust
// ember-rs/src/agent/tools/registry.rs
...
```rust
// ember-rs/src/agent/tools/security.rs
...
_本文档定义了 Ember AI Agent 功能的架构设计，随着开发进展会持续更新。_
