# LobsterAI 业务闭环对标与 Ember AI Agent 规划

## 1. 文档目标

本文从**资深架构师**与**产品经理**双视角，对 `LobsterAI` 与 `Ember` 做业务闭环级对标，明确：
...
- `ember-rs/src/services/heartbeat_service/mod.rs`
- `ember-rs/src/services/heartbeat_service/delivery.rs`
- `ember-rs/src/commands/aster_agent_cmd/mod.rs`
- `ember-rs/src/commands/aster_agent_cmd/tool_runtime/subagent_tools.rs`
- `ember-rs/crates/websocket/src/handlers/rpc_handler.rs`
...
Ember 的底座（追踪、权限、沙箱、Provider 能力）已经具备，当前应避免重构冲动，重点补齐远程触发和任务治理层。
