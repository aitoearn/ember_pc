...
```rust
// ember-rs/src/agent/tests/message_tests.rs
...
```rust
// ember-rs/src/agent/tests/tool_integration_tests.rs
...
```rust
// ember-rs/src/agent/tests/e2e_tests.rs
...
```rust
// ember-rs/src/agent/tests/graders/code_grader.rs
...
```rust
// ember-rs/src/agent/tests/graders/model_grader.rs
...
```rust
// ember-rs/src/agent/tests/graders/human_grader.rs
...
```rust
// ember-rs/src/agent/tests/capability_tests.rs
...
```rust
// ember-rs/src/agent/tests/regression_tests.rs
...
```rust
// ember-rs/src/agent/tests/edge_case_tests.rs
...
```rust
// ember-rs/src/agent/tests/metrics.rs
...
```rust
// ember-rs/src/agent/tests/trial_runner.rs
...
```rust
// ember-rs/src/agent/tests/mocks/mock_provider.rs
...
```rust
// ember-rs/src/agent/tests/mocks/mock_fs.rs
...
jobs:
  test:
    ...
    steps:
      ...
      - name: Run unit tests
        run: cd ember-rs && cargo test
      
      - name: Run integration tests
        run: cd ember-rs && cargo test --test '*'
      
      - name: Run clippy
        run: cd ember-rs && cargo clippy -- -D warnings
```
...
*本文档定义 AI Agent 功能的通用测试策略；具体产品可以在此基础上追加项目级场景、Evidence Pack 和发布门禁。*
