...
npm run agent-qc:release-summary -- --evidence "./.ember/qc/agent-qc-evidence.json" --require-scenario-manifest "internal/test/agent-qc-scenarios.manifest.json" --require-risk P0 --tag "<release-tag>" --output "./.ember/qc/release-agent-qc.md" --check
