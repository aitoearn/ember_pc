...
flowchart TB
    subgraph ProductShells["产品壳 / Host Shells"]
        Claw["Claw / Ember Desktop<br/>旗舰 Agent 工作台"]
...
flowchart TD
    ...
    B -- "Ember Desktop / Claw / 本地独立 App" --> C["Client Adapter Registry"]
...
flowchart TD
    ...
    F -.禁止.-> H["ember-rs internal crates"]
