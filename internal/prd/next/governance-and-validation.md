...
3. Claw shell：作为 Ember Desktop 旗舰壳，不作为共享组件包。
...
4. 前端共享已有 `@embercloud/agent-app-runtime` / projection 雏形，但 Claw UI primitives 尚未系统抽边界。
