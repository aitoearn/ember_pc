...
| App Server       | `ember-rs/crates/app-server/**`                                                            | P1 decision contract 和 approval response       |
| RuntimeCore      | `ember-rs/crates/**/runtime**`                                                             | waiter、decision、session cache                 |
