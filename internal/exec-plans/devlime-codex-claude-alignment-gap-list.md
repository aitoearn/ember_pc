...
- 参考：
  - Lime：`ember-rs/crates/agent-rust/crates/agent/src/tools/mod.rs`
  - Lime：`ember-rs/crates/agent-rust/crates/agent/src/tools/registry.rs`
...
- 参考：
  ...
  - `ember-rs/crates/agent-rust/crates/agent/src/providers/*`
  - `ember-rs/crates/agent-rust/crates/agent/src/agents/*`
- 期望：
...
- 参考：
  ...
  - Lime：`ember-rs/crates/agent-rust/crates/agent/src/skills/*`
  - Lime：`ember-rs/crates/agent-rust/crates/agent/src/hooks/*`
- 期望：
...
- 参考：
  ...
  - Lime：`ember-rs/crates/agent-rust/crates/agent/src/tools/agent_control.rs`
  - Lime：`ember-rs/crates/agent-rust/crates/agent/src/tools/team_tools.rs`
- 期望：
