...
- `current`
  - `ember-rs/src/agent_tools/catalog.rs` 中的 `LIME_CREATE_*_TASK_TOOL_NAME`
  - `ember-rs/src/commands/agent_cmd/tool_runtime/creation_tools.rs`
  - `ember-rs/src/commands/agent_cmd/tool_runtime/media_cli_bridge.rs`
  - `ember-rs/src/commands/agent_cmd/tool_runtime/social_tools.rs` 的 `social_generate_cover_image`
