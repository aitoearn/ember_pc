...
| 10   | `internal/exec-plans/agent-tools-test-batches/batch-10-content-workbench-tools.md`             | `ember_create_*_task / social_generate_cover_image / GenerateImage / media task artifact metadata`                              |
| 11   | `internal/exec-plans/agent-tools-test-batches/batch-11-browser-assist-site-tools.md`           | `ember_site_* / ember_search_web_images / compat ember_run_service_skill`                                                         |
