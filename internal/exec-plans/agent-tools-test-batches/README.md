...
- native tool 注册入口：`ember-rs/crates/agent-rust/crates/agent/src/tools/mod.rs`
- native alias 事实源：`ember-rs/crates/agent-rust/crates/agent/src/tools/registry.rs`
