...
- `current`
  - `ember-rs/crates/agent-rust/crates/agent/src/tools/view_image.rs`
  - `ember-rs/crates/agent-rust/crates/agent/src/tools/mod.rs` 中注册的 `ViewImageTool`
  - `ember-rs/crates/agent-rust/crates/agent/src/agents/agent.rs` 中 model-visible image content 转换
...
- `deprecated`
  - `ember-rs/crates/agent-rust/crates/agent/src/tools/analyze_image.rs`
...
```bash
CARGO_TARGET_DIR="/Users/coso/Documents/dev/ai/aiclientproxy/lime/ember-rs/target" cargo test --manifest-path "ember-rs/crates/agent-rust/Cargo.toml" -p agent-core view_image -- --nocapture
CARGO_TARGET_DIR="/Users/coso/Documents/dev/ai/aiclientproxy/lime/ember-rs/target" cargo test --manifest-path "ember-rs/crates/agent-rust/Cargo.toml" -p agent-core test_native_tool_result_to_call_tool_result_attaches_model_visible_image -- --nocapture
CARGO_TARGET_DIR="/Users/coso/Documents/dev/ai/aiclientproxy/lime/ember-rs/target" cargo test --manifest-path "ember-rs/crates/agent-rust/Cargo.toml" -p agent-core test_list_tools_excludes_legacy_agent_control_surface -- --nocapture
```
