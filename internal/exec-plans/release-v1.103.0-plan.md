...
- `release metadata`：`package.json`、`packages/ember-cli-npm/package.json`、`ember-rs/Cargo.toml`、`ember-rs/Cargo.lock`、`RELEASE_NOTES.md`、`RELEASE_NOTES.en.md`、`.gitignore`、本计划。
