...
- 2026-06-08 Codex TW-Q2-FILE-UPLOAD-WRAPPER 认领
  - 写集：`ember-rs/src/app/runner.rs`、`ember-rs/src/commands/mod.rs`、`ember-rs/src/commands/file_upload_cmd.rs`、`internal/exec-plans/tauri-wrapper-quick-cleanup-queue.md`
...
- 2026-06-08 Codex TW-Q2-PERSONA-WRAPPER 认领
  - 写集：`ember-rs/src/app/runner.rs`、`ember-rs/src/commands/mod.rs`、`ember-rs/src/commands/persona_cmd.rs`、`internal/exec-plans/tauri-wrapper-quick-cleanup-queue.md`
...
- 2026-06-08 Codex TW-Q1-DOCS-SMOKE 认领
  - 写集：`internal/roadmap/agentui/README.md`、`internal/roadmap/agentui/ember-agentui-target-architecture.md`、`internal/roadmap/agentui/ember-agentui-code-map.md`、`internal/roadmap/agentui/ember-agentui-backend-coordination.md`、`internal/roadmap/agentui/ember-agentui-implementation-roadmap.md`、`internal/roadmap/agentui/conversation-projection-implementation-plan.md`、`scripts/electron/current-docs-guard.test.mjs`、`internal/exec-plans/tauri-wrapper-quick-cleanup-queue.md`
...
- 2026-06-08 main TW-Q0-INVENTORY 完成
  ...
  - 验证结果：`git diff --check -- ".gitignore" ".codex/skills/ember-command-boundary/references/commands.md" "internal/aiprompts/commands.md" "internal/exec-plans/tauri-wrapper-command-inventory.md" "internal/exec-plans/tauri-wrapper-quick-cleanup-queue.md" "internal/roadmap/agentapp/p17-formal-entry-contract.md" "internal/roadmap/agentapp/p17-lifecycle-cleanup-contract-hardening.md" "internal/roadmap/agentapp/p18-typed-capability-sdk-gate.md" "internal/roadmap/agentapp/p18-7-full-ember-capability-surface.md" "internal/roadmap/agentapp/p17-4-host-bridge-runtime.md" "internal/roadmap/agentui/html-preview-provider-readiness-20260526.md" "internal/roadmap/agentui/ember-agentui-standard-alignment.md"` 通过。
...
- 2026-06-08 main TW-Q0-COMMANDS-DIR-FREEZE 认领
  - 写集：`AGENTS.md`、`internal/aiprompts/commands.md`、`.codex/skills/ember-command-boundary/references/commands.md`、`internal/exec-plans/tauri-wrapper-quick-cleanup-queue.md`、`internal/exec-plans/tauri-wrapper-command-inventory.md`
...
- 2026-06-08 main TW-Q0-COMMANDS-DIR-FREEZE 完成
  ...
  - 旧入口搜索：`rg -n "ember-rs/src/commands/\\*\\*.*清理区|不再承接新的业务逻辑|不再落新的业务逻辑|新增业务逻辑、API adapter" "AGENTS.md" "internal/aiprompts/commands.md" ".codex/skills/ember-command-boundary/references/commands.md" "internal/exec-plans/tauri-wrapper-quick-cleanup-queue.md" "internal/exec-plans/tauri-wrapper-command-inventory.md"` 命中 9 处。
...
- 2026-06-08 main TW-Q0-COMMANDS-DIR-HARD-FREEZE 完成
  ...
  - 验证结果：`git diff --check -- "AGENTS.md" "internal/aiprompts/commands.md" ".codex/skills/ember-command-boundary/references/commands.md" "internal/exec-plans/tauri-wrapper-quick-cleanup-queue.md" "internal/exec-plans/tauri-wrapper-command-inventory.md"` 通过。
...
- 2026-06-08 main TW-Q0-COMMANDS-DIR-STUB-GUARD 认领
  ...
  - 只读参考：`ember-rs/src/commands/**`、`internal/aiprompts/commands.md`、`.codex/skills/ember-command-boundary/references/commands.md`
  - 避让：`ember-rs/src/commands/**`、`ember-rs/src/app/runner.rs`、App Server protocol、Electron host、`src/lib/governance/agentCommandCatalog.json`、`src/lib/dev-bridge/commandPolicy.ts`、`internal/roadmap/appserver/**`
...
- 2026-06-08 main TW-Q0-COMMAND-SKILL-STUB-RULE 认领
  - 写集：`.codex/skills/ember-command-boundary/references/commands.md`、`internal/exec-plans/tauri-wrapper-quick-cleanup-queue.md`
...
- 2026-06-08 main TW-Q0-COMMAND-SKILL-STUB-RULE 完成
  ...
  - 旧入口搜索：`rg -n '在 `ember-rs/src/commands/\*\*` 新增业务逻辑' "internal/aiprompts/commands.md" ".codex/skills/ember-command-boundary/references/commands.md"` 两处一致命中。
  - 验证结果：`git diff --check -- ".codex/skills/ember-command-boundary/references/commands.md" "internal/exec-plans/tauri-wrapper-quick-cleanup-queue.md"` 通过。
...
- 2026-06-08 main TW-Q0-COMMAND-SKILL-BODY-RULE 认领
  - 写集：`.codex/skills/ember-command-boundary/SKILL.md`、`internal/exec-plans/tauri-wrapper-quick-cleanup-queue.md`
  - 只读参考：`.codex/skills/ember-command-boundary/references/commands.md`、`internal/aiprompts/commands.md`
  - 避让：`ember-rs/src/commands/**`、`runner.rs`、App Server protocol、Electron host、`commandPolicy.ts`、`agentCommandCatalog.json`
...
- 2026-06-08 main TW-Q0-COMMAND-SKILL-BODY-RULE 完成
  ...
  - 验证结果：`git diff --check -- ".codex/skills/ember-command-boundary/SKILL.md" ".codex/skills/ember-command-boundary/references/commands.md" "internal/exec-plans/tauri-wrapper-quick-cleanup-queue.md"` 通过。
...
- 2026-06-08 main TW-Q1-AGENTAPP-AGENTUI-DOC-TERMS 认领
  - 写集：`internal/roadmap/agentapp/p17-formal-entry-contract.md`、`internal/roadmap/agentapp/p17-lifecycle-cleanup-contract-hardening.md`、`internal/roadmap/agentapp/p18-typed-capability-sdk-gate.md`、`internal/roadmap/agentapp/p18-7-full-ember-capability-surface.md`、`internal/roadmap/agentapp/p17-4-host-bridge-runtime.md`、`internal/roadmap/agentui/html-preview-provider-readiness-20260526.md`、`internal/roadmap/agentui/ember-agentui-standard-alignment.md`、`internal/exec-plans/tauri-wrapper-quick-cleanup-queue.md`
...
- 2026-06-08 Codex TW-Q2-USAGE-STATS-WRAPPER 认领
  - 写集：`ember-rs/src/app/runner.rs`、`ember-rs/src/commands/mod.rs`、`ember-rs/src/commands/usage_stats_cmd.rs`、`internal/exec-plans/tauri-wrapper-quick-cleanup-queue.md`
...
- 2026-06-08 Codex TW-Q2-VOICE-TEST-WRAPPER 认领
  - 写集：`ember-rs/src/app/runner.rs`、`ember-rs/src/commands/mod.rs`、`ember-rs/src/commands/voice_test_cmd.rs`、`internal/exec-plans/tauri-wrapper-quick-cleanup-queue.md`
...
- 2026-06-08 Codex TW-Q4A-WINDOW-WRAPPER 认领
  - 写集：`ember-rs/src/app/runner.rs`、`ember-rs/src/commands/mod.rs`、`ember-rs/src/commands/window_cmd.rs`、`src/lib/desktop-host/configSystemMocks.ts`、`src/lib/desktop-host/configSystemMocks.test.ts`、`internal/exec-plans/tauri-wrapper-quick-cleanup-queue.md`
...
- 2026-06-08 Codex TW-Q2-ECOMMERCE-REVIEW-REPLY-WRAPPER 完成
  - 写集：`ember-rs/src/app/runner.rs`、`ember-rs/src/commands/mod.rs`、`ember-rs/src/commands/ecommerce_review_reply_cmd.rs`、`src/lib/governance/rustCommandsCurrentBoundary.test.ts`、`scripts/check-command-contracts.mjs`、`internal/exec-plans/tauri-wrapper-quick-cleanup-queue.md`
  - 避让：Knowledge 写集、Electron host / ipc 共享热区、App Server protocol、`commandPolicy.ts`、`agentCommandCatalog.json`
...
- 2026-06-08 Codex TW-Q2-ORPHAN-STUB-FILES 完成
  - 写集：`ember-rs/src/commands/config_cmd.rs`、`ember-rs/src/commands/document_import_cmd.rs`、`ember-rs/src/commands/experimental_cmd.rs`、`ember-rs/src/commands/external_tools_cmd.rs`、`ember-rs/src/commands/image_search_cmd.rs`、`ember-rs/src/commands/image_upload_cmd.rs`、`ember-rs/src/commands/models_cmd.rs`、`ember-rs/src/commands/prompt_cmd.rs`、`ember-rs/src/commands/theme_context_cmd.rs`、`scripts/check-command-contracts.mjs`、`src/lib/governance/rustCommandsCurrentBoundary.test.ts`、`internal/exec-plans/tauri-wrapper-quick-cleanup-queue.md`
  ...
  - 旧入口搜索：`rg -n "config_cmd|document_import_cmd|experimental_cmd|external_tools_cmd|image_search_cmd|image_upload_cmd|models_cmd|prompt_cmd|window_cmd|voice_test_cmd" "ember-rs/src" -g "*.rs"` 无命中；`rg -n "theme_context_cmd|aster_agent_theme_context_search" "ember-rs/src" "scripts/check-command-contracts.mjs" "internal/aiprompts/query-loop.md" -g "!*target*"` 只剩文档历史锚点和 contract 守卫。
...
- 2026-06-08 Codex TW-Q5A-KNOWLEDGE-DEAD-FILES 完成
  - 写集：`ember-rs/src/commands/knowledge_cmd.rs`、`ember-rs/src/dev_bridge/dispatcher/knowledge.rs`、`scripts/check-command-contracts.mjs`、`src/lib/governance/rustCommandsCurrentBoundary.test.ts`、`internal/exec-plans/tauri-wrapper-quick-cleanup-queue.md`
...
- 2026-06-08 Codex TW-Q0-COMMANDS-DIR-DOCS-BROADCAST 完成
  ...
  - 清理结果：`guard-hardened`；`docs/README.md`、`internal/README.md`、`internal/aiprompts/README.md`、治理文档、质量文档和 `current-rules-guard.test.mjs` 已同步知道 `ember-rs/src/commands/**` 是旧 Tauri wrapper 删除清理区，不再承接业务逻辑、API adapter、runtime 分支、领域 service、compat wrapper 或退场 stub；入口链接只指向已版本化的 `tauri-wrapper-quick-cleanup-queue.md` 与 `tauri-wrapper-command-inventory.md`，不再把被 `.gitignore` 忽略的本地计划当事实源。
  - 旧入口搜索：`rg -n "ember-rs/src/commands/\\*\\*" "docs/README.md" "internal/README.md" "internal/aiprompts/README.md" "internal/aiprompts/governance.md" "internal/aiprompts/quality-workflow.md" "scripts/electron/current-rules-guard.test.mjs"` 命中 6 处。
...
- 2026-06-08 Codex TW-Q2-TELEMETRY-WRAPPER 完成
  - 写集：`ember-rs/src/app/telemetry_state.rs`、`ember-rs/src/app/mod.rs`、`ember-rs/src/app/state.rs`、`ember-rs/src/app/bootstrap.rs`、`ember-rs/src/app/commands/server.rs`、`ember-rs/src/commands/media_task_cmd.rs`、`ember-rs/src/commands/mod.rs`、`ember-rs/src/commands/telemetry_cmd.rs`、`scripts/check-command-contracts.mjs`、`src/lib/governance/rustCommandsCurrentBoundary.test.ts`、`internal/exec-plans/tauri-wrapper-quick-cleanup-queue.md`
...
- 2026-06-08 Codex TW-Q0-COMMANDS-DIR-DOCS-BROADCAST-2 完成
  ...
  - 旧入口搜索：`rg -n "legacy desktop facade 命令，仅用于兼容迁移|只允许委托 service|只保留参数适配|退场包装|ember-rs/src/commands/update_cmd.rs" "internal/aiprompts" "internal/roadmap/appserver" "internal/README.md" "docs/README.md"` 已不再命中误导性 current 表述；仍保留的 `薄委托` 只出现在 App Server 完成态中“不能保留薄委托”的禁止语义。
  ...
  - 剩余阻塞：Harness 技术文档中的旧脚本路径需要单独治理；本轮不夹写 `internal/tech/harness/**`。后续若继续清理 `ember-rs/src/commands/**`，仍按命令族撤 runner / dispatcher / catalog / mock 注册后删除，不能补 stub / compat wrapper。

- 2026-06-08 Codex TW-Q2-A2UI-WEBSOCKET-WRAPPERS 完成
  - 写集：`ember-rs/src/app/runner.rs`、`ember-rs/src/commands/mod.rs`、`ember-rs/src/commands/a2ui_form_cmd.rs`、`ember-rs/src/commands/websocket_cmd.rs`、`scripts/check-command-contracts.mjs`、`src/lib/governance/rustCommandsCurrentBoundary.test.ts`、`internal/exec-plans/tauri-wrapper-quick-cleanup-queue.md`
...
- 2026-06-08 Codex TW-Q4B-TRAY-WRAPPER 完成
  - 写集：`ember-rs/src/app/runner.rs`、`ember-rs/src/commands/mod.rs`、`ember-rs/src/commands/tray_cmd.rs`、`scripts/check-command-contracts.mjs`、`src/lib/governance/rustCommandsCurrentBoundary.test.ts`、`internal/exec-plans/tauri-wrapper-quick-cleanup-queue.md`
...
- 2026-06-08 Codex TW-Q2-TELEGRAM-REMOTE-WRAPPER 完成
  - 写集：`ember-rs/src/app/runner.rs`、`ember-rs/src/commands/mod.rs`、`ember-rs/src/commands/telegram_remote_cmd.rs`、`scripts/check-command-contracts.mjs`、`src/lib/governance/rustCommandsCurrentBoundary.test.ts`、`internal/exec-plans/tauri-wrapper-quick-cleanup-queue.md`
...
- 2026-06-08 Codex TW-Q2-MODEL-FETCH-HELPER-WRAPPER 完成
  - 写集：`ember-rs/src/app/runner.rs`、`ember-rs/src/commands/model_registry_cmd.rs`、`scripts/check-command-contracts.mjs`、`src/lib/governance/rustCommandsCurrentBoundary.test.ts`、`internal/exec-plans/tauri-wrapper-command-inventory.md`、`internal/exec-plans/tauri-wrapper-quick-cleanup-queue.md`
...
- 2026-06-08 Codex TW-Q2-SYSINFO-GET-FACADE 完成
  - 写集：`ember-rs/src/app/runner.rs`、`ember-rs/src/services/sysinfo_service.rs`、`scripts/check-command-contracts.mjs`、`internal/exec-plans/tauri-wrapper-command-inventory.md`、`internal/exec-plans/tauri-wrapper-quick-cleanup-queue.md`
  ...
  - 旧入口搜索：`rg -n "get_sysinfo|subscribe_sysinfo|unsubscribe_sysinfo" "ember-rs/src" "src" "electron" "packages" "scripts" "internal/exec-plans" --glob "!ember-rs/target/**"` 显示 `get_sysinfo` 只剩 `scripts/check-command-contracts.mjs` retired guard 和执行计划 / inventory 记录；订阅命令仍只在 runner、sysinfo bridge 与测试 mock 中。
...
- 2026-06-08 Codex TW-Q2-MEMORY-FEEDBACK-STATS-FACADE 完成
  - 写集：`ember-rs/src/app/runner.rs`、`ember-rs/src/commands/memory_feedback_cmd.rs`、`scripts/check-command-contracts.mjs`、`src/lib/governance/rustCommandsCurrentBoundary.test.ts`、`internal/exec-plans/tauri-wrapper-command-inventory.md`、`internal/exec-plans/tauri-wrapper-quick-cleanup-queue.md`
  ...
  - 旧入口搜索：`rg -n "get_memory_feedback_stats|FeedbackStats|calculate_approval_rate|get_recent_feedbacks|unified_memory_feedback" "ember-rs/src" "src" "electron" "packages" "scripts" "internal/exec-plans" --glob "!ember-rs/target/**"` 显示 `get_memory_feedback_stats` 只剩执行计划 / inventory 历史记录；`unified_memory_feedback` 仍在 runner 和 `memory_feedback_cmd.rs`。
...
- 2026-06-08 Codex TW-Q2-MATERIALS-BATCH-CONTENT-FACADE 完成
  - 写集：`ember-rs/src/app/runner.rs`、`ember-rs/src/commands/material_cmd.rs`、`scripts/check-command-contracts.mjs`、`src/lib/governance/rustCommandsCurrentBoundary.test.ts`、`internal/exec-plans/tauri-wrapper-command-inventory.md`、`internal/exec-plans/tauri-wrapper-quick-cleanup-queue.md`
  ...
  - 旧入口搜索：`rg -n "get_materials_content|MaterialService::get_materials_content|get_material_content" "ember-rs/src" "src" "electron" "packages" "scripts" "internal/exec-plans" --glob "!ember-rs/target/**"` 显示 `get_materials_content` 只剩执行计划 / inventory 记录；`get_material_content` 仍在 runner、`material_cmd.rs` 和前端 `src/lib/api/materials.ts`。
...
- 2026-06-08 Codex TW-Q2-WORKSPACE-PROJECT-CONTEXT-FACADE 完成
  - 写集：`ember-rs/src/app/runner.rs`、`ember-rs/src/commands/workspace_cmd.rs`、`scripts/check-command-contracts.mjs`、`src/lib/governance/rustCommandsCurrentBoundary.test.ts`、`internal/exec-plans/tauri-wrapper-command-inventory.md`、`internal/exec-plans/tauri-wrapper-quick-cleanup-queue.md`
  ...
  - 旧入口搜索：`rg -n "get_project_context|ProjectContextBuilder|ProjectContext" "ember-rs/src" "src" "electron" "packages" "scripts" "internal/exec-plans" --glob "!ember-rs/target/**"` 显示 `get_project_context` 只剩执行计划 / inventory 记录和 `scripts/check-command-contracts.mjs` retired guard；`ProjectContextBuilder` 仍被 `build_project_system_prompt` 使用。
...
- 2026-06-08 Codex TW-Q2-AGENT-APP-PICKER-TAURI-WRAPPER 完成
  - 写集：`ember-rs/src/commands/agent_app_cmd.rs`、`src/lib/dev-bridge/commandPolicy.ts`、`src/lib/governance/rustCommandsCurrentBoundary.test.ts`、`internal/exec-plans/tauri-wrapper-quick-cleanup-queue.md`
  ...
  - 旧入口搜索：`rg -n "agent_app_select_directory|AgentAppSelectDirectory|agent_app_select_directory_result|agent_app_select_directory_from_window" "ember-rs/src" "src/lib/dev-bridge" "src/lib/desktop-host" "src/lib/api/agentApps.ts" "electron" "scripts/check-command-contracts.mjs" "internal/exec-plans" --glob "!ember-rs/target/**"` 显示旧 Rust wrapper / runner / DevBridge truth 已无命中，命令名只剩 Electron Host current、前端 API 网关、负向 mock 测试、contract required command 和执行计划记录。
...
- 2026-06-08 Codex TW-Q4C-COMPANION-WRAPPER 完成
  - 写集：`ember-rs/src/app/runner.rs`、`ember-rs/src/commands/mod.rs`、`ember-rs/src/commands/companion_cmd.rs`、`scripts/check-command-contracts.mjs`、`src/lib/governance/rustCommandsCurrentBoundary.test.ts`、`internal/exec-plans/tauri-wrapper-quick-cleanup-queue.md`
...
- 2026-06-08 Codex TW-Q8A-WEBVIEW-PANEL-WRAPPERS 完成
  - 写集：`ember-rs/src/app/runner.rs`、`ember-rs/src/app/bootstrap.rs`、`ember-rs/src/commands/webview_cmd.rs`、`src/lib/webview-api.ts`、`src/lib/webview-api.d.ts`、`scripts/check-command-contracts.mjs`、`src/lib/governance/rustCommandsCurrentBoundary.test.ts`、`internal/exec-plans/tauri-wrapper-quick-cleanup-queue.md`
...
- 2026-06-08 Codex TW-Q2-CONNECT-COMMANDS-STATE-MOVE 完成
  - 写集：`ember-rs/src/app/connect_state.rs`、`ember-rs/src/app/mod.rs`、`ember-rs/src/app/bootstrap.rs`、`ember-rs/src/app/runner.rs`、`ember-rs/src/dev_bridge.rs`、`ember-rs/src/commands/connect_cmd.rs`、`ember-rs/src/commands/mod.rs`、`scripts/check-command-contracts.mjs`、`src/lib/governance/rustCommandsCurrentBoundary.test.ts`、`internal/exec-plans/tauri-wrapper-quick-cleanup-queue.md`
...
- 2026-06-08 Codex TW-Q0-APPSERVER-DOCS-COMMAND-CLEANUP-BROADCAST 完成
  ...
  - 旧入口搜索：`rg -n "ember-rs/src/commands/\\*\\*|旧 Tauri wrapper 清理区|新增 / 复活 ember-rs/src/commands wrapper" "internal/roadmap/appserver/prd.md" "internal/roadmap/appserver/protocol.md" "internal/roadmap/appserver/consumer-integration.md" "internal/roadmap/appserver/flowcharts.md" "internal/roadmap/appserver/sequences.md" "internal/roadmap/appserver/frontend-integration-matrix.md"` 命中预期边界说明。
...
- 2026-06-08 Codex TW-Q0-CURRENT-DOCS-COMMANDS-DIR-BROADCAST-3 完成
  ...
  - 旧入口搜索：`rg -n "legacy desktop command glue 退回 thin facade|legacy desktop 命令只作为 thin facade|command glue 只做 compat facade|如果新增 Tauri command|若新增 Tauri command，必须|Tauri command 只做薄适配|tauri::generate_handler!" ...` 在本轮 current 文档写集不再命中；`rg -n '\| `ember-rs/src/commands/aster_agent_cmd/.+` \| (turn 执行主链|session create|subagent runtime|tool bridge|后端 DTO|current)' "internal/roadmap/agentui/ember-agentui-code-map.md"` 不再命中误导性 current 表述。历史执行记录和过往审计里的“未新增 Tauri command”过去事实不作为 current 指引。
...
- 2026-06-08 Codex TW-Q0-CURRENT-DOCS-COMMANDS-DIR-BROADCAST-4 完成
  ...
  - 旧入口搜索：`rg -n "ember-rs/src/commands/\\*\\*|硬边界|生产命令 current|旧 Tauri wrapper 清理区|fail-closed stub|thin facade|tombstone|新增 Rust 后端能力进入 App Server|桌面壳能力进入 Electron Desktop Host" "docs/README.md" "internal/README.md" "internal/exec-plans/README.md" "internal/exec-plans/production-command-current-migration-plan.md" "internal/roadmap/appserver/service-extraction.md" "scripts/electron/current-rules-guard.test.mjs"` 命中预期边界说明。
