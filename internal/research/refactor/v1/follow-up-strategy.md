...
| Codex 变化 | Lime owner |
| --- | --- |
| app-server protocol | `ember-rs/crates/app-server-protocol`、`packages/app-server-client` |
| method serialization scope | `ember-rs/crates/app-server-protocol`、App Server processor、`packages/app-server-client` |
| schema fixtures / export | `ember-rs/crates/app-server-protocol/src/schema_export.rs`、protocol type generation、contract tests |
| app-server processor | `ember-rs/crates/app-server/src/processor/*` |
| core session / task runtime | `ember-rs/crates/app-server/src/runtime/*`、`ember-rs/crates/agent/src/*`、RuntimeCore |
