...
- `ember-rs/crates/mcp/src/manager/**` 的 runtime startup status/snapshot owner
- `ember-rs/crates/agent/src/mcp_bridge.rs` 与相关定向 tests
- `ember-rs/crates/app-server/src/runtime_backend/mcp_bridges.rs` 与定向 tests
