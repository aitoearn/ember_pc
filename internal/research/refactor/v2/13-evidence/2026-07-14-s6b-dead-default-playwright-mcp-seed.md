...
- Deleted `ember-rs/crates/core/src/database/migration_v3.rs`.
...
- `rustfmt --edition 2021 --check ember-rs/crates/core/src/database/mod.rs ember-rs/crates/core/src/database/startup_migrations.rs`：通过。
- `git diff --check -- ember-rs/crates/core/src/database/mod.rs ember-rs/crates/core/src/database/startup_migrations.rs ember-rs/crates/core/src/database/migration_v3.rs src/lib/governance/legacySurfaceCatalog.json src/lib/governance/legacySurfaceCatalog.test.ts`：通过。
- `cargo test --manifest-path ember-rs/Cargo.toml -p lime-core`：通过。
- `npm run test:rust:related -- ember-rs/crates/core/src/database/mod.rs ember-rs/crates/core/src/database/startup_migrations.rs ember-rs/crates/core/src/database/migration_v3.rs`：通过。
