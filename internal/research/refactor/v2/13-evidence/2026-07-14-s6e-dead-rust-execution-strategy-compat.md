...
- 删除 `ember-rs/crates/agent/src/execution_strategy_compat.rs` 及其 32 行测试；
- 删除 `ember-rs/crates/agent/src/lib.rs` 的 module declaration；
...
- `rg --glob '*.rs' "execution_strategy_compat|normalize_execution_strategy_to_react" ember-rs`：删除后零命中；
