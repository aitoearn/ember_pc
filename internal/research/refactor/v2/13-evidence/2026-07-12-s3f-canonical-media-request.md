...
- `CARGO_TARGET_DIR=/tmp/lime-refactor-v2-verify-target cargo test --manifest-path ember-rs/Cargo.toml -p lime-media-runtime --lib`
  - result: pass
  - 51 passed
- `CARGO_TARGET_DIR=/tmp/lime-refactor-v2-verify-target cargo test --manifest-path ember-rs/Cargo.toml -p lime-media-runtime --test model_route_execution`
  - result: pass
  - 9 passed
