...
判断 Ember 的发布材料、官网文档和帮助文档，是否已经具备独立于桌面 App 的翻译工作流。
...
- `docs/README.md`、`docs/content/`、`internal/aiprompts/`、`internal/develop/`、`docs/ops.md`、`internal/bussniss/`、`internal/oem/` 目前仍以中文为主。
...
- `internal/roadmap/i18n/release-docs-translation-scope.json` 已定义发布材料 / 官网文档 / 帮助文档的 `required / pilot / source-only` 翻译范围，当前 required 项为 README 与 Release Notes，pilot 项为文档首页；`internal/roadmap/i18n/companions/docs-content-index.en.md` 已作为文档首页英文 companion pilot，inventory 会把 required companion 缺失作为门禁，把后续新增 pilot companion 缺失作为 advisory。
- 文档首页英文 companion 现在放在 roadmap companion 目录，不放入 `docs/content/`；在文档站没有 locale route 前，这避免把 companion 误发布成普通内容页。
- `internal/roadmap/i18n/evidence/release-docs-workflow-inventory.json` 现在输出 `releaseDocsTranslationQueue`，从 translation scope 生成可审阅队列；当前队列状态为 `ready`，missing source / required companion blocker / pilot companion missing 均为 `0`，12 个 `source-only` 帮助文档 / API reference / open platform / legal 页面进入后续翻译候选队列。
- `internal/roadmap/i18n/evidence/docs-locale-build-manifest.json` 现在输出独立于 Nuxt route emission 的 build-time manifest；当前 `workflowStatus=ready`，source locale 为 `zh-CN`，target locales 为 `en-US`，15 个 scope entry 中 3 个已有 companion、12 个进入 source-only 候选队列，missing source / required companion missing / pilot companion missing 均为 `0`。
...
- 术语控制：复用 `internal/roadmap/i18n/glossary.md` 和 PR 模板，避免发布材料与帮助文档各自长出不同词表。
...
- [README.md](</Users/coso/Documents/dev/ai/aiclientproxy/ember/README.md>)
- [README.en.md](</Users/coso/Documents/dev/ai/aiclientproxy/ember/README.en.md>)
- [RELEASE_NOTES.md](</Users/coso/Documents/dev/ai/aiclientproxy/ember/RELEASE_NOTES.md>)
- [RELEASE_NOTES.en.md](</Users/coso/Documents/dev/ai/aiclientproxy/ember/RELEASE_NOTES.en.md>)
- [release-docs-translation-scope.json](</Users/coso/Documents/dev/ai/aiclientproxy/ember/internal/roadmap/i18n/release-docs-translation-scope.json>)
- [release-docs-workflow-inventory.json](</Users/coso/Documents/dev/ai/aiclientproxy/ember/internal/roadmap/i18n/evidence/release-docs-workflow-inventory.json>)
- [docs-locale-build-manifest.json](</Users/coso/Documents/dev/ai/aiclientproxy/ember/internal/roadmap/i18n/evidence/docs-locale-build-manifest.json>)
- [docs-content-index.en.md](</Users/coso/Documents/dev/ai/aiclientproxy/ember/internal/roadmap/i18n/companions/docs-content-index.en.md>)
- [docs/README.md](</Users/coso/Documents/dev/ai/aiclientproxy/ember/docs/README.md>)
- [docs/package.json](</Users/coso/Documents/dev/ai/aiclientproxy/ember/docs/package.json>)
- [docs/nuxt.config.ts](</Users/coso/Documents/dev/ai/aiclientproxy/ember/docs/nuxt.config.ts>)
