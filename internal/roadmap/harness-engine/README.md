...
| ------------------------------------- | ------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| System Prompts / 规则注入             | 已落地        | `ember-rs/src/services/memory_profile_prompt_service.rs`、`ember-rs/src/services/memory_source_resolver_service.rs`                                                                                                                                          | Lime 已把 profile、memory source、project rule 注入到 system prompt 主链，不是裸 prompt 模式                                                                                                                  |
| Filesystem / Durable Storage          | 已落地        | `internal/aiprompts/overview.md`、`ember-rs/src/commands/agent_cmd/tool_runtime/workspace_tools.rs`                                                                                                                                                         | Workspace、artifact、项目目录、文件工具都已经进入主链                                                                                                                                                         |
| Bash / Code Execution                 | 已落地        | `ember-rs/src/agent_tools/catalog.rs`、`ember-rs/src/agent_tools/execution.rs`                                                                                                                                                                               | Lime 已具备通用执行能力，不依赖“预先定义完所有工具”                                                                                                                                                           |
...
| Tools / Skills / MCP / Browser        | 已落地        | `internal/aiprompts/skill-standard.md`、`internal/aiprompts/command-runtime.md`、`ember-rs/src/agent_tools/catalog.rs`                                                                                                                                                | Lime 已有较完整 capability surface，不是单一 chat tool 模型                                                                                                                                                   |
...
| Context Rot 治理                      | 部分落地      | `ember-rs/src/commands/agent_cmd/command_api/runtime_api.rs`、`ember-rs/crates/agent-rust/crates/agent/src/context_mgmt/mod.rs`、`ember-rs/crates/agent/src/tool_io_offload.rs`、`ember-rs/crates/agent-rust/crates/agent/src/context/compressor.rs` | 已有 compact、tool output compression、tool offload，但产品侧可见性与默认治理还不够强                                                                                                                         |
| Long-Horizon Execution                | 部分落地      | `ember-rs/src/commands/agent_cmd/runtime_turn.rs`、`ember-rs/src/commands/agent_cmd/tool_runtime/subagent_tools.rs`、`ember-rs/src/commands/agent_cmd/command_api/runtime_api.rs`                                                         | 已有 auto continue、provider continuation、subagent、queue/resume，但还没形成统一 completion loop                                                                                                             |
| Verification / Replay / Review        | 部分落地      | `internal/aiprompts/harness-engine-governance.md`、`ember-rs/src/commands/agent_cmd/command_api/runtime_api.rs`、`src/lib/agentRuntime/harnessVerificationPresentation.ts`、`ember-rs/src/services/runtime_review_decision_service.rs`                     | evidence / replay / analysis / review 已成链；前端 verification 展示语义已收敛到共享 helper，review template 也开始直接携带同一份 structured verification summary，但验证结果尚未成为所有后续动作的默认硬约束 |
...
- `ember-rs/src/commands/agent_cmd/tool_runtime/workspace_tools.rs`
...
- `ember-rs/src/commands/agent_cmd/command_api/runtime_api.rs`
  证明 Lime 已有 `agent_runtime_compact_session`、resume thread、thread read model、evidence export 这类 runtime 操作主链。
- `ember-rs/crates/agent-rust/crates/agent/src/context_mgmt/mod.rs`
  证明 Agent 已有 continuation message 与 compact 后续写逻辑，Lime 不是完全没有 continuation。
- `ember-rs/crates/agent-rust/crates/agent/src/context/compressor.rs`
...
- `ember-rs/src/commands/agent_cmd/runtime_turn.rs`
