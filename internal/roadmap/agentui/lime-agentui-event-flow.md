...
| Artifact/Evidence files | `.ember/artifacts`、`.ember/harness` | Workbench、Harness、Review、Replay |
...
flowchart TB
  ...
  ArtifactService --> Files[.ember/artifacts]
...
flowchart TB
  ...
  EvidenceService --> Files[.ember/harness/sessions/<session>/evidence]
  ...
  ReviewService --> ReviewFiles[.ember/harness/sessions/<session>/review]
```
