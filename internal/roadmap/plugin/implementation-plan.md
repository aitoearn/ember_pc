...
- 验证：`cargo test --manifest-path "ember-rs/Cargo.toml" -p app-server plugin_worker -- --nocapture`、`npm test -- "src/lib/api/agentApps.test.ts"`。
