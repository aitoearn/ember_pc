...
4. Ember 面向普通创作者，不能把 Claude Code / OpenClaw / Hermes 的记忆工作台直接作为前台体验。
5. Ember 的产品形态更应靠近 Ribbi：单主生成容器、少量入口、后台持续进化 taste / reference / memory / feedback。
