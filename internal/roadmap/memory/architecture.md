...
这些能力必须受开发者面板或高级设置控制，默认 off；这不等于关闭 Ember 的基础记忆能力：
...
| Claude Code 层 | Ember 底层 | Ember 前台 |
| --- | --- | --- |
...
3. `ember-rs/src/commands/memory_management_cmd.rs`
4. `ember-rs/src/services/memory_source_resolver_service.rs`
5. `ember-rs/src/commands/aster_agent_cmd/runtime_turn.rs`
6. `src/lib/api/unifiedMemory.ts`
7. `ember-rs/src/commands/unified_memory_cmd.rs`
...
2. `ember-rs/src/commands/memory_cmd.rs`
