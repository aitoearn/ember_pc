...
- `ember-rs/crates/agent-rust/crates/agent/src/sandbox/**`
...
- `ember-rs/crates/agent/src/agent_tools/execution/process.rs`
- `ember-rs/crates/app-server/src/runtime_backend/coding_events/command.rs`
...
- `ember-rs/crates/agent-rust/crates/agent/src/sandbox/restricted_token.rs`
...
- `ember-rs/crates/agent/src/agent_tools/execution/decision.rs`
- `ember-rs/crates/agent/src/agent_tools/execution/service.rs`
...
| dead       | `ember-rs/src/**`、旧 Tauri command wrapper、生产 mock fallback                                                 | 不得恢复。                                                          |
