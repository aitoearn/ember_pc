...
- 不恢复 `ember-rs/src/**` 或旧 Tauri command wrapper。
- 不把生产计划链路降级到 mock。
...
- 不把 Provider catalog 回退到已下线本地 `ember-rs/resources/models`。
...
- 不读取已下线本地 `ember-rs/resources/models` catalog。
...
```text
ember-rs/crates/agent-rust/crates/agent/src/
  agents/
...
```text
ember-rs/crates/app-server/src/runtime_backend/model_capability/
  mod.rs
...
```text
ember-rs/crates/agent-rust/crates/agent/src/agents/plan/*_tests.rs
ember-rs/crates/app-server/src/runtime_backend/plan_events_tests.rs
ember-rs/crates/app-server/src/runtime_backend/model_capability/*_tests.rs
ember-rs/crates/app-server/src/runtime_backend/reasoning_events_tests.rs
