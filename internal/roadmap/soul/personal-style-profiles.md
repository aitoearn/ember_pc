...
ember-rs/crates/app-server/src/runtime/soul/
...
ember-rs/crates/app-server/src/personal_style/  # dead：不得新增
ember-rs/crates/personal-style/         # dead：不得新增
```
...
| Agent identity 底座            | `ember-rs/crates/agent/src/agent_state_support.rs`                                       | `current` | 只保留产品身份和硬边界，不写固定“专业友好助手”口吻。                                                                        |
