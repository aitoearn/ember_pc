...
Lime 现有 `internal/knowledge` 已经沉淀了 Markdown-first 项目知识库、个人 IP 知识库 Builder Skill 原型、Skill 与知识包边界等早期方案。它们证明了一个方向：
...
1. `internal/knowledge/lime-knowledge-base-construction-blueprint.md`。
2. `internal/knowledge/markdown-first-knowledge-pack-plan.md`。
3. `internal/knowledge/lime-project-knowledge-base-solution.md`。
