...
> 状态：proposal  
> 更新时间：2026-05-05  
> 目标：把 AI 图片生成升级为可编辑的设计工程输出，让 Ember 能生成、调整、重生成和导出多图层海报 / 封面 / 商品图，而不是只返回一张扁平图片。
...
- [../../research/ai-layered-design/ember-gap-analysis.md](../../research/ai-layered-design/ember-gap-analysis.md)
...
**用现成图像模型生成和编辑资产，用 Ember 自己的 `LayeredDesignDocument` 承载图层工程。**

一句话北极星：

**Ember 的图片生成从“输出图片”升级为“输出可编辑设计工程”。**
...
`LayeredDesignDocument` 是 Ember AI 设计项目的唯一 current 事实源。
